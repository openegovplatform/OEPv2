...
/**
 * The persistence utility for the user parameter service. This utility wraps {@link UserParameterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class UserParameterUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(UserParameter userParameter) {
		getPersistence().clearCache(userParameter);
	}
	 ...
	 */
	public static List<UserParameter> findWithDynamicQuery(
	 ...
	 */
	public static UserParameter update(UserParameter userParameter)
		throws SystemException {
		return getPersistence().update(userParameter);
	}
	...
	public static UserParameter update(UserParameter userParameter,
		...
		return getPersistence().update(userParameter, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(userParameter);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(userParameters);
	}
	...
	*/
	public static org.oep.core.datamgt.parameter.model.UserParameter create(
		long userParameterId) {
		return getPersistence().create(userParameterId);
	}
	...
	*/
	public static org.oep.core.datamgt.parameter.model.UserParameter remove(
		long userParameterId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.core.datamgt.parameter.NoSuchUserParameterException {
		return getPersistence().remove(userParameterId);
	}

	public static org.oep.core.datamgt.parameter.model.UserParameter updateImpl(
		org.oep.core.datamgt.parameter.model.UserParameter userParameter)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(userParameter);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.datamgt.parameter.model.UserParameter findByPrimaryKey(
		long userParameterId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.core.datamgt.parameter.NoSuchUserParameterException {
		return getPersistence().findByPrimaryKey(userParameterId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.datamgt.parameter.model.UserParameter fetchByPrimaryKey(
		long userParameterId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(userParameterId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.core.datamgt.parameter.model.UserParameter> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static UserParameterPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (UserParameterPersistence)PortletBeanLocatorUtil.locate(org.oep.core.datamgt.parameter.service.ClpSerializer.getServletContextName(),
					UserParameterPersistence.class.getName());

			ReferenceRegistry.registerReference(UserParameterUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(UserParameterPersistence persistence) {
	}

	private static UserParameterPersistence _persistence;
}