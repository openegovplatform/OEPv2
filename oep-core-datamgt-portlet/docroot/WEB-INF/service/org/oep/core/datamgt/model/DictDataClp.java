...
public class DictDataClp extends BaseModelImpl<DictData> implements DictData {
	...
	public void setGroupId(long groupId) {
		...
		if (_dictDataRemoteModel != null) {
			try {
				...
				method.invoke(_dictDataRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_dictDataRemoteModel != null) {
			try {
				...
				method.invoke(_dictDataRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("org.oep.core.datamgt.model.DictData");
	...
	private Class<?> _clpSerializerClass = org.oep.core.datamgt.service.ClpSerializer.class;
}