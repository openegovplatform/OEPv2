...
public class DictDataWrapper implements DictData, ModelWrapper<DictData> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.core.datamgt.model.DictData dictData) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.datamgt.model.DictData> toCacheModel() {
		return _dictData.toCacheModel();
	}

	@Override
	public org.oep.core.datamgt.model.DictData toEscapedModel() {
		return new DictDataWrapper(_dictData.toEscapedModel());
	}

	@Override
	public org.oep.core.datamgt.model.DictData toUnescapedModel() {
