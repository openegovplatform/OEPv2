...
/**
 * Provides the local service interface for DefaultParameter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author TrungDK
 * @see DefaultParameterLocalServiceUtil
...
public interface DefaultParameterLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DefaultParameterLocalServiceUtil} to access the default parameter local service. Add custom service methods to {@link org.oep.core.datamgt.parameter.service.impl.DefaultParameterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
