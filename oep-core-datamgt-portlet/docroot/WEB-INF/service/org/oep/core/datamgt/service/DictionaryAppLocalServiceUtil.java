...
/**
 * Provides the local service utility for DictionaryApp. This utility wraps
 * {@link org.oep.core.datamgt.service.impl.DictionaryAppLocalServiceImpl} and is the
 ...
 * @generated
 */
public class DictionaryAppLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.oep.core.datamgt.service.impl.DictionaryAppLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static DictionaryAppLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DictionaryAppLocalService.class.getName());

			if (invokableLocalService instanceof DictionaryAppLocalService) {
				_service = (DictionaryAppLocalService)invokableLocalService;
			}
			else {
				_service = new DictionaryAppLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(DictionaryAppLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(DictionaryAppLocalService service) {
	}

	private static DictionaryAppLocalService _service;
}