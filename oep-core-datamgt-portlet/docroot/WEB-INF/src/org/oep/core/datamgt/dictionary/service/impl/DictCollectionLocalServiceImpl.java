...
import org.oep.core.datamgt.dictionary.service.base.DictCollectionLocalServiceBaseImpl;
...
import org.oep.core.datamgt.dictionary.DictCollectionStatusException;
import org.oep.core.datamgt.dictionary.DictCollectionTitleException;
import org.oep.core.datamgt.dictionary.DictCollectionVersionException;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link org.oep.core.datamgt.dictionary.service.DictCollectionLocalService} interface.
 *
 * <p>
 ...
 * @see org.oep.core.datamgt.dictionary.service.DictCollectionLocalServiceUtil
 */
public class DictCollectionLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link org.oep.core.datamgt.dictionary.service.DictCollectionLocalServiceUtil} to access the dictionary collection local service.
	 */
	/** 
	...
	public DictCollection getDictCollectionByName(String collectionName, ServiceContext serviceContext) throws SystemException {
		return dictCollectionPersistence.fetchByC_N_S(serviceContext.getCompanyId(), collectionName, 1, false);
	}
	...
	public int countDictCollectionByC_LikeN(String name, ServiceContext serviceContext) throws SystemException {
		return dictCollectionPersistence.countByC_LikeN(serviceContext.getCompanyId(), name);
	}

	public Collection<DictCollection> getByLikeName(String name, ServiceContext serviceContext) throws SystemException {
		return dictCollectionPersistence.findByC_LikeN(serviceContext.getCompanyId(), name);
	}
	
	public Collection<DictCollection> getByLikeName(String name, int startIndex, int endIndex, ServiceContext serviceContext) throws SystemException {
		return dictCollectionPersistence.findByC_LikeN(serviceContext.getCompanyId(), name, startIndex, endIndex);
	}
