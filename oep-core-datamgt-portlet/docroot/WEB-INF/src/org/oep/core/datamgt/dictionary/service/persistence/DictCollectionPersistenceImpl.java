...
import org.oep.core.datamgt.dictionary.NoSuchDictCollectionException;
...
import org.oep.core.datamgt.dictionary.model.impl.DictCollectionModelImpl;
...
public class DictCollectionPersistenceImpl extends BasePersistenceImpl<DictCollection>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_N_S = new FinderPath(DictCollectionModelImpl.ENTITY_CACHE_ENABLED,
			DictCollectionModelImpl.FINDER_CACHE_ENABLED,
			DictCollectionImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByC_N_S",
			new String[] {
				Long.class.getName(), String.class.getName(),
	 ...
	 */
	@Override
	public DictCollection findByC_N_S(long companyId, String name, int status)
		throws NoSuchDictCollectionException, SystemException {
		DictCollection dictCollection = fetchByC_N_S(companyId, name, status);
	 ...
	 */
	@Override
	public DictCollection fetchByC_N_S(long companyId, String name, int status)
		throws SystemException {
		return fetchByC_N_S(companyId, name, status, true);
	}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"DictCollectionPersistenceImpl.fetchByC_N_S(long, String, int, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((dictCollection.getCompanyId() != companyId) ||
							(dictCollection.getName() == null) ||
							!dictCollection.getName().equals(name) ||
							(dictCollection.getStatus() != status)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_N_S,
							finderArgs, dictCollection);
					}
				}
	 ...
	 */
	@Override
	public DictCollection removeByC_N_S(long companyId, String name, int status)
		throws NoSuchDictCollectionException, SystemException {
		DictCollection dictCollection = findByC_N_S(companyId, name, status);
	 ...
	 */
	@Override
	public List<org.oep.core.datamgt.dictionary.model.DictData> getDictDatas(
	...
	public void addDictDatas(long pk,
		List<org.oep.core.datamgt.dictionary.model.DictData> dictDatas)
		throws SystemException {
		for (org.oep.core.datamgt.dictionary.model.DictData dictData : dictDatas) {
			dictCollectionToDictDataTableMapper.addTableMapping(pk,
				dictData.getPrimaryKey());
		}
	}
	...
	public void setDictDatas(long pk,
		...
		try {
			...
			for (int i = 0; i < dictDatas.size(); i++) {
				org.oep.core.datamgt.dictionary.model.DictData dictData = dictDatas.get(i);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.core.datamgt.dictionary.model.DictCollection")));
	...
	protected TableMapper<DictCollection, org.oep.core.datamgt.dictionary.model.DictData> dictCollectionToDictDataTableMapper;
