...
import org.oep.core.datamgt.NoSuchDictAttributeException;
import org.oep.core.datamgt.model.DictAttribute;
import org.oep.core.datamgt.model.impl.DictAttributeImpl;
import org.oep.core.datamgt.model.impl.DictAttributeModelImpl;
...
public class DictAttributePersistenceImpl extends BasePersistenceImpl<DictAttribute>
	 ...
	 * @throws org.oep.core.datamgt.NoSuchDictAttributeException if a matching dictionary attribute could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	 ...
	 * @throws org.oep.core.datamgt.NoSuchDictAttributeException if a dictionary attribute with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG", new String[] { Long.class.getName() },
			DictAttributeModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DictAttribute> findByG(long groupId) throws SystemException {
	 ...
	 */
	@Override
	public List<DictAttribute> findByG(long groupId, int start, int end)
		throws SystemException {
	...
	public List<DictAttribute> findByG(long groupId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (DictAttribute dictAttribute : list) {
				if ((groupId != dictAttribute.getGroupId())) {
					list = null;
	 ...
	 */
	@Override
	public DictAttribute findByG_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<DictAttribute> list = findByG(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute findByG_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<DictAttribute> list = findByG(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute[] findByG_PrevAndNext(long dictAttributeId,
		...
		try {
			...
			array[0] = getByG_PrevAndNext(session, dictAttribute, groupId,
					orderByComparator, true);

			array[1] = dictAttribute;

			array[2] = getByG_PrevAndNext(session, dictAttribute, groupId,
					orderByComparator, false);
	...
	protected DictAttribute getByG_PrevAndNext(Session session,
		DictAttribute dictAttribute, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG(long groupId) throws SystemException {
		for (DictAttribute dictAttribute : findByG(groupId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_G_GROUPID_2 = "dictAttribute.groupId = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_CN = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_CN",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_CN = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_CN",
			new String[] { Long.class.getName(), String.class.getName() },
			DictAttributeModelImpl.GROUPID_COLUMN_BITMASK |
			DictAttributeModelImpl.COLLECTIONNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_CN = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DictAttribute> findByG_CN(long groupId, String collectionName)
		throws SystemException {
	 ...
	 */
	@Override
	public DictAttribute findByG_CN_First(long groupId, String collectionName,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_CN_First(groupId,
				collectionName, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_CN_First(long groupId, String collectionName,
		OrderByComparator orderByComparator) throws SystemException {
		List<DictAttribute> list = findByG_CN(groupId, collectionName, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute findByG_CN_Last(long groupId, String collectionName,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_CN_Last(groupId, collectionName,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_CN_Last(long groupId, String collectionName,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<DictAttribute> list = findByG_CN(groupId, collectionName,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute[] findByG_CN_PrevAndNext(long dictAttributeId,
		...
		try {
			...
			array[0] = getByG_CN_PrevAndNext(session, dictAttribute, groupId,
					collectionName, orderByComparator, true);

			array[1] = dictAttribute;

			array[2] = getByG_CN_PrevAndNext(session, dictAttribute, groupId,
					collectionName, orderByComparator, false);
	...
	protected DictAttribute getByG_CN_PrevAndNext(Session session,
		DictAttribute dictAttribute, long groupId, String collectionName,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_CN(long groupId, String collectionName)
		throws SystemException {
		for (DictAttribute dictAttribute : findByG_CN(groupId, collectionName,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dictAttribute);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_CN_GROUPID_2 = "dictAttribute.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_CN_COLLECTIONNAME_1 = "dictAttribute.collectionName IS NULL";
	private static final String _FINDER_COLUMN_G_CN_COLLECTIONNAME_2 = "dictAttribute.collectionName = ?";
	private static final String _FINDER_COLUMN_G_CN_COLLECTIONNAME_3 = "(dictAttribute.collectionName IS NULL OR dictAttribute.collectionName = '')";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_CN_DT = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_CN_DT",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_CN_DT =
		new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_CN_DT",
			...
			DictAttributeModelImpl.COLLECTIONNAME_COLUMN_BITMASK |
			DictAttributeModelImpl.DATATYPE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_CN_DT = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_CN_DT",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public List<DictAttribute> findByG_CN_DT(long groupId,
		String collectionName, String dataType) throws SystemException {
		return findByG_CN_DT(groupId, collectionName, dataType,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<DictAttribute> findByG_CN_DT(long groupId,
		String collectionName, String dataType, int start, int end)
		throws SystemException {
		return findByG_CN_DT(groupId, collectionName, dataType, start, end, null);
	}
	...
	public List<DictAttribute> findByG_CN_DT(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_CN_DT;
			finderArgs = new Object[] { groupId, collectionName, dataType };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_CN_DT;
			finderArgs = new Object[] {
					groupId, collectionName, dataType,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_CN_DT_GROUPID_2);

			boolean bindCollectionName = false;

			if (collectionName == null) {
				query.append(_FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_1);
			}
			else if (collectionName.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_3);
			}
			else {
				bindCollectionName = true;

				query.append(_FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_2);
			}

			boolean bindDataType = false;

			if (dataType == null) {
				query.append(_FINDER_COLUMN_G_CN_DT_DATATYPE_1);
			}
			else if (dataType.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_CN_DT_DATATYPE_3);
			}
			else {
				bindDataType = true;

				query.append(_FINDER_COLUMN_G_CN_DT_DATATYPE_2);
			}
	 ...
	 */
	@Override
	public DictAttribute findByG_CN_DT_First(long groupId,
		String collectionName, String dataType,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_CN_DT_First(groupId,
				collectionName, dataType, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_CN_DT_First(long groupId,
		String collectionName, String dataType,
		OrderByComparator orderByComparator) throws SystemException {
		List<DictAttribute> list = findByG_CN_DT(groupId, collectionName,
				dataType, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute findByG_CN_DT_Last(long groupId,
		String collectionName, String dataType,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_CN_DT_Last(groupId,
				collectionName, dataType, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_CN_DT_Last(long groupId,
		String collectionName, String dataType,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByG_CN_DT(groupId, collectionName, dataType);
	 ...
	 */
	@Override
	public DictAttribute[] findByG_CN_DT_PrevAndNext(long dictAttributeId,
		long groupId, String collectionName, String dataType,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = findByPrimaryKey(dictAttributeId);
		...
		try {
			...
			array[0] = getByG_CN_DT_PrevAndNext(session, dictAttribute,
					groupId, collectionName, dataType, orderByComparator, true);

			array[1] = dictAttribute;

			array[2] = getByG_CN_DT_PrevAndNext(session, dictAttribute,
					groupId, collectionName, dataType, orderByComparator, false);
	...
	protected DictAttribute getByG_CN_DT_PrevAndNext(Session session,
		DictAttribute dictAttribute, long groupId, String collectionName,
		String dataType, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_CN_DT(long groupId, String collectionName,
		String dataType) throws SystemException {
		for (DictAttribute dictAttribute : findByG_CN_DT(groupId,
				collectionName, dataType, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(dictAttribute);
		}
	 ...
	 */
	@Override
	public int countByG_CN_DT(long groupId, String collectionName,
		String dataType) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_CN_DT;

		Object[] finderArgs = new Object[] { groupId, collectionName, dataType };
	...
	private static final String _FINDER_COLUMN_G_CN_DT_GROUPID_2 = "dictAttribute.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_1 = "dictAttribute.collectionName IS NULL AND ";
	private static final String _FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_2 = "dictAttribute.collectionName = ? AND ";
	private static final String _FINDER_COLUMN_G_CN_DT_COLLECTIONNAME_3 = "(dictAttribute.collectionName IS NULL OR dictAttribute.collectionName = '') AND ";
	private static final String _FINDER_COLUMN_G_CN_DT_DATATYPE_1 = "dictAttribute.dataType IS NULL";
	private static final String _FINDER_COLUMN_G_CN_DT_DATATYPE_2 = "dictAttribute.dataType = ?";
	private static final String _FINDER_COLUMN_G_CN_DT_DATATYPE_3 = "(dictAttribute.dataType IS NULL OR dictAttribute.dataType = '')";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_DT = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_DT",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_DT = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED,
			DictAttributeImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_DT",
			new String[] { Long.class.getName(), String.class.getName() },
			DictAttributeModelImpl.GROUPID_COLUMN_BITMASK |
			DictAttributeModelImpl.DATATYPE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_DT = new FinderPath(DictAttributeModelImpl.ENTITY_CACHE_ENABLED,
			DictAttributeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DictAttribute> findByG_DT(long groupId, String dataType)
		throws SystemException {
		return findByG_DT(groupId, dataType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DictAttribute> findByG_DT(long groupId, String dataType,
		int start, int end) throws SystemException {
		return findByG_DT(groupId, dataType, start, end, null);
	}
	...
	public List<DictAttribute> findByG_DT(long groupId, String dataType,
		...
		if (list == null) {
			...
			if (dataType == null) {
				query.append(_FINDER_COLUMN_G_DT_DATATYPE_1);
			}
			else if (dataType.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_DT_DATATYPE_3);
			}
			else {
				bindDataType = true;

				query.append(_FINDER_COLUMN_G_DT_DATATYPE_2);
			}
	 ...
	 */
	@Override
	public DictAttribute findByG_DT_First(long groupId, String dataType,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_DT_First(groupId, dataType,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_DT_First(long groupId, String dataType,
		OrderByComparator orderByComparator) throws SystemException {
		List<DictAttribute> list = findByG_DT(groupId, dataType, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute findByG_DT_Last(long groupId, String dataType,
		OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = fetchByG_DT_Last(groupId, dataType,
				orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute fetchByG_DT_Last(long groupId, String dataType,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByG_DT(groupId, dataType);

		if (count == 0) {
			return null;
		}

		List<DictAttribute> list = findByG_DT(groupId, dataType, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public DictAttribute[] findByG_DT_PrevAndNext(long dictAttributeId,
		long groupId, String dataType, OrderByComparator orderByComparator)
		throws NoSuchDictAttributeException, SystemException {
		DictAttribute dictAttribute = findByPrimaryKey(dictAttributeId);
		...
		try {
			...
			array[0] = getByG_DT_PrevAndNext(session, dictAttribute, groupId,
					dataType, orderByComparator, true);

			array[1] = dictAttribute;

			array[2] = getByG_DT_PrevAndNext(session, dictAttribute, groupId,
					dataType, orderByComparator, false);
	...
	protected DictAttribute getByG_DT_PrevAndNext(Session session,
		DictAttribute dictAttribute, long groupId, String dataType,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_DT(long groupId, String dataType)
		throws SystemException {
		for (DictAttribute dictAttribute : findByG_DT(groupId, dataType,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dictAttribute);
		}
	}
	 ...
	 */
	@Override
	public int countByG_DT(long groupId, String dataType)
		throws SystemException {
	...
	private static final String _FINDER_COLUMN_G_DT_GROUPID_2 = "dictAttribute.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_DT_DATATYPE_1 = "dictAttribute.dataType IS NULL";
	private static final String _FINDER_COLUMN_G_DT_DATATYPE_2 = "dictAttribute.dataType = ?";
	private static final String _FINDER_COLUMN_G_DT_DATATYPE_3 = "(dictAttribute.dataType IS NULL OR dictAttribute.dataType = '')";
	...
	public DictAttribute updateImpl(
		...
		if (isNew || !DictAttributeModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dictAttributeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						dictAttributeModelImpl.getOriginalGroupId()
					};
				...
				args = new Object[] { dictAttributeModelImpl.getGroupId() };
			...
			if ((dictAttributeModelImpl.getColumnBitmask() &
				...
				args = new Object[] {
						dictAttributeModelImpl.getGroupId(),
						dictAttributeModelImpl.getCollectionName()
					};
			...
			if ((dictAttributeModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_CN_DT.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dictAttributeModelImpl.getOriginalGroupId(),
						dictAttributeModelImpl.getOriginalCollectionName(),
						dictAttributeModelImpl.getOriginalDataType()
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_CN_DT, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_CN_DT,
					args);
	...
	/**
	 * Returns the dictionary attribute with the primary key or throws a {@link org.oep.core.datamgt.NoSuchDictAttributeException} if it could not be found.
	 *
	 * @param dictAttributeId the primary key of the dictionary attribute
	 * @return the dictionary attribute
	 * @throws org.oep.core.datamgt.NoSuchDictAttributeException if a dictionary attribute with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.core.datamgt.model.DictAttribute")));
