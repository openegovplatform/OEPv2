...
import org.oep.core.datamgt.NoSuchDictCollectionException;
import org.oep.core.datamgt.model.DictCollection;
import org.oep.core.datamgt.model.impl.DictCollectionImpl;
import org.oep.core.datamgt.model.impl.DictCollectionModelImpl;
...
public class DictCollectionPersistenceImpl extends BasePersistenceImpl<DictCollection>
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG_N(long groupId, String name)
		throws SystemException {
	...
	public DictCollection[] filterFindByG_N_PrevAndNext(long dictCollectionId,
		...
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_N_PrevAndNext(dictCollectionId, groupId, name,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG_LikeN(long groupId, String name)
		throws SystemException {
	 ...
	 */
	@Override
	public DictCollection[] filterFindByG_LikeN_PrevAndNext(
		long dictCollectionId, long groupId, String name,
		OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeN_PrevAndNext(dictCollectionId, groupId, name,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_LikeN_PrevAndNext(session, dictCollection,
					groupId, name, orderByComparator, true);

			array[1] = dictCollection;

			array[2] = filterGetByG_LikeN_PrevAndNext(session, dictCollection,
					groupId, name, orderByComparator, false);
	...
	protected DictCollection filterGetByG_LikeN_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId, String name,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG_LikeN_V(long groupId,
		String name, String version) throws SystemException {
		return filterFindByG_LikeN_V(groupId, name, version, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<DictCollection> filterFindByG_LikeN_V(long groupId,
		String name, String version, int start, int end)
		throws SystemException {
		return filterFindByG_LikeN_V(groupId, name, version, start, end, null);
	}
	...
	public List<DictCollection> filterFindByG_LikeN_V(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeN_V(groupId, name, version, start, end,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public DictCollection[] filterFindByG_LikeN_V_PrevAndNext(
		long dictCollectionId, long groupId, String name, String version,
		OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeN_V_PrevAndNext(dictCollectionId, groupId, name,
				version, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_LikeN_V_PrevAndNext(session,
					dictCollection, groupId, name, version, orderByComparator,
					true);

			array[1] = dictCollection;

			array[2] = filterGetByG_LikeN_V_PrevAndNext(session,
					dictCollection, groupId, name, version, orderByComparator,
					false);
	...
	protected DictCollection filterGetByG_LikeN_V_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId, String name,
		String version, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public int filterCountByG_LikeN_V(long groupId, String name, String version)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_LikeN_V(groupId, name, version);
		}
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG_N_S(long groupId, String name,
		int status) throws SystemException {
		return filterFindByG_N_S(groupId, name, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DictCollection> filterFindByG_N_S(long groupId, String name,
		int status, int start, int end) throws SystemException {
		return filterFindByG_N_S(groupId, name, status, start, end, null);
	}
	...
	public List<DictCollection> filterFindByG_N_S(long groupId, String name,
		...
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_N_S(groupId, name, status, start, end,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public DictCollection[] filterFindByG_N_S_PrevAndNext(
		long dictCollectionId, long groupId, String name, int status,
		OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_N_S_PrevAndNext(dictCollectionId, groupId, name,
				status, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_N_S_PrevAndNext(session, dictCollection,
					groupId, name, status, orderByComparator, true);

			array[1] = dictCollection;

			array[2] = filterGetByG_N_S_PrevAndNext(session, dictCollection,
	...
	protected DictCollection filterGetByG_N_S_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId, String name, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public int filterCountByG_N_S(long groupId, String name, int status)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_N_S(groupId, name, status);
		}
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG(long groupId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG(long groupId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public DictCollection[] filterFindByG_PrevAndNext(long dictCollectionId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_PrevAndNext(dictCollectionId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_PrevAndNext(session, dictCollection,
					groupId, orderByComparator, true);

			array[1] = dictCollection;

			array[2] = filterGetByG_PrevAndNext(session, dictCollection,
	...
	protected DictCollection filterGetByG_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<org.oep.core.datamgt.model.DictData> getDictDatas(long pk)
		throws SystemException {
	...
	public void addDictData(long pk,
		org.oep.core.datamgt.model.DictData dictData) throws SystemException {
	...
	public void addDictDatas(long pk,
		List<org.oep.core.datamgt.model.DictData> dictDatas)
		throws SystemException {
		for (org.oep.core.datamgt.model.DictData dictData : dictDatas) {
			dictCollectionToDictDataTableMapper.addTableMapping(pk,
				dictData.getPrimaryKey());
		}
	}
	...
	public void setDictDatas(long pk,
		...
		try {
			...
			for (int i = 0; i < dictDatas.size(); i++) {
				org.oep.core.datamgt.model.DictData dictData = dictDatas.get(i);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.core.datamgt.model.DictCollection")));
	...
	protected TableMapper<DictCollection, org.oep.core.datamgt.model.DictData> dictCollectionToDictDataTableMapper;
	...
	private static final String _FILTER_SQL_SELECT_DICTCOLLECTION_WHERE = "SELECT DISTINCT {dictCollection.*} FROM oep_datamgt_dictcollection dictCollection WHERE ";
	private static final String _FILTER_SQL_SELECT_DICTCOLLECTION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {oep_datamgt_dictcollection.*} FROM (SELECT DISTINCT dictCollection.dictCollectionId FROM oep_datamgt_dictcollection dictCollection WHERE ";
	private static final String _FILTER_SQL_SELECT_DICTCOLLECTION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN oep_datamgt_dictcollection ON TEMP_TABLE.dictCollectionId = oep_datamgt_dictcollection.dictCollectionId";
	private static final String _FILTER_SQL_COUNT_DICTCOLLECTION_WHERE = "SELECT COUNT(DISTINCT dictCollection.dictCollectionId) AS COUNT_VALUE FROM oep_datamgt_dictcollection dictCollection WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "dictCollection";
	private static final String _FILTER_ENTITY_TABLE = "oep_datamgt_dictcollection";
	private static final String _ORDER_BY_ENTITY_ALIAS = "dictCollection.";
	private static final String _ORDER_BY_ENTITY_TABLE = "oep_datamgt_dictcollection.";
