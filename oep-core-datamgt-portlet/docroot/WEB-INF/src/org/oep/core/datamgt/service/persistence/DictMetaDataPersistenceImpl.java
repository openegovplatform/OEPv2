...
import org.oep.core.datamgt.NoSuchDictMetaDataException;
import org.oep.core.datamgt.model.DictMetaData;
import org.oep.core.datamgt.model.impl.DictMetaDataImpl;
import org.oep.core.datamgt.model.impl.DictMetaDataModelImpl;
...
public class DictMetaDataPersistenceImpl extends BasePersistenceImpl<DictMetaData>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_DI_AN = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, DictMetaDataImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByC_DI_AN",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_DI_AN = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_DI_AN",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public DictMetaData findByC_DI_AN(long companyId, long dictDataId,
		String attributeName)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = fetchByC_DI_AN(companyId, dictDataId,
				attributeName);
	 ...
	 */
	@Override
	public DictMetaData fetchByC_DI_AN(long companyId, long dictDataId,
		String attributeName) throws SystemException {
		return fetchByC_DI_AN(companyId, dictDataId, attributeName, true);
	}
	...
	public DictMetaData fetchByC_DI_AN(long companyId, long dictDataId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_C_DI_AN,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_DI_AN_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_DI_AN_DICTDATAID_2);

			boolean bindAttributeName = false;

			if (attributeName == null) {
				query.append(_FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_1);
			}
			else if (attributeName.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_3);
			}
			else {
				bindAttributeName = true;

				query.append(_FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_DI_AN,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"DictMetaDataPersistenceImpl.fetchByC_DI_AN(long, long, String, boolean) with parameters (" +
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_DI_AN,
					finderArgs);
	 ...
	 */
	@Override
	public DictMetaData removeByC_DI_AN(long companyId, long dictDataId,
		String attributeName)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = findByC_DI_AN(companyId, dictDataId,
				attributeName);
	 ...
	 */
	@Override
	public int countByC_DI_AN(long companyId, long dictDataId,
		String attributeName) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_DI_AN;
	...
	private static final String _FINDER_COLUMN_C_DI_AN_COMPANYID_2 = "dictMetaData.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_DI_AN_DICTDATAID_2 = "dictMetaData.dictDataId = ? AND ";
	private static final String _FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_1 = "dictMetaData.attributeName IS NULL";
	private static final String _FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_2 = "dictMetaData.attributeName = ?";
	private static final String _FINDER_COLUMN_C_DI_AN_ATTRIBUTENAME_3 = "(dictMetaData.attributeName IS NULL OR dictMetaData.attributeName = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_DI = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, DictMetaDataImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_G_DI",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_DI =
		new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, DictMetaDataImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_G_DI",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			DictMetaDataModelImpl.COMPANYID_COLUMN_BITMASK |
			DictMetaDataModelImpl.GROUPID_COLUMN_BITMASK |
			DictMetaDataModelImpl.DICTDATAID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_DI = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_G_DI",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
	 ...
	 */
	@Override
	public List<DictMetaData> findByC_G_DI(long companyId, long groupId,
		long dictDataId) throws SystemException {
		return findByC_G_DI(companyId, groupId, dictDataId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<DictMetaData> findByC_G_DI(long companyId, long groupId,
		long dictDataId, int start, int end) throws SystemException {
		return findByC_G_DI(companyId, groupId, dictDataId, start, end, null);
	}
	...
	@Override
	public List<DictMetaData> findByC_G_DI(long companyId, long groupId,
		long dictDataId, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_DI;
			finderArgs = new Object[] { companyId, groupId, dictDataId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_DI;
			finderArgs = new Object[] {
					companyId, groupId, dictDataId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (DictMetaData dictMetaData : list) {
				if ((companyId != dictMetaData.getCompanyId()) ||
						(groupId != dictMetaData.getGroupId()) ||
						(dictDataId != dictMetaData.getDictDataId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_G_DI_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_G_DI_GROUPID_2);

			query.append(_FINDER_COLUMN_C_G_DI_DICTDATAID_2);
	 ...
	 */
	@Override
	public DictMetaData findByC_G_DI_First(long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = fetchByC_G_DI_First(companyId, groupId,
	 ...
	 */
	@Override
	public DictMetaData fetchByC_G_DI_First(long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator)
		throws SystemException {
		List<DictMetaData> list = findByC_G_DI(companyId, groupId, dictDataId,
	 ...
	 */
	@Override
	public DictMetaData findByC_G_DI_Last(long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = fetchByC_G_DI_Last(companyId, groupId,
				dictDataId, orderByComparator);
	 ...
	 */
	@Override
	public DictMetaData fetchByC_G_DI_Last(long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByC_G_DI(companyId, groupId, dictDataId);
	 ...
	 */
	@Override
	public DictMetaData[] findByC_G_DI_PrevAndNext(long dictMetaDataId,
		...
		try {
			...
			array[0] = getByC_G_DI_PrevAndNext(session, dictMetaData,
					companyId, groupId, dictDataId, orderByComparator, true);

			array[1] = dictMetaData;

			array[2] = getByC_G_DI_PrevAndNext(session, dictMetaData,
					companyId, groupId, dictDataId, orderByComparator, false);
	...
	protected DictMetaData getByC_G_DI_PrevAndNext(Session session,
		DictMetaData dictMetaData, long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DictMetaData> filterFindByC_G_DI(long companyId, long groupId,
		long dictDataId) throws SystemException {
		return filterFindByC_G_DI(companyId, groupId, dictDataId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<DictMetaData> filterFindByC_G_DI(long companyId, long groupId,
		long dictDataId, int start, int end) throws SystemException {
		return filterFindByC_G_DI(companyId, groupId, dictDataId, start, end,
			null);
	}
	...
	public List<DictMetaData> filterFindByC_G_DI(long companyId, long groupId,
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByC_G_DI(companyId, groupId, dictDataId, start, end,
				orderByComparator);
		}
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DICTMETADATA_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_DICTMETADATA_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DICTMETADATA_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DictMetaDataModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				DictMetaData.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, DictMetaDataImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, DictMetaDataImpl.class);
			}
			...
			return (List<DictMetaData>)QueryUtil.list(q, getDialect(), start,
				end);
		}
		catch (Exception e) {
			throw processException(e);
	 ...
	 */
	@Override
	public DictMetaData[] filterFindByC_G_DI_PrevAndNext(long dictMetaDataId,
		long companyId, long groupId, long dictDataId,
		OrderByComparator orderByComparator)
		throws NoSuchDictMetaDataException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByC_G_DI_PrevAndNext(dictMetaDataId, companyId, groupId,
				dictDataId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByC_G_DI_PrevAndNext(session, dictMetaData,
					companyId, groupId, dictDataId, orderByComparator, true);

			array[1] = dictMetaData;

			array[2] = filterGetByC_G_DI_PrevAndNext(session, dictMetaData,
					companyId, groupId, dictDataId, orderByComparator, false);
	...
	protected DictMetaData filterGetByC_G_DI_PrevAndNext(Session session,
		DictMetaData dictMetaData, long companyId, long groupId,
		long dictDataId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByC_G_DI(long companyId, long groupId, long dictDataId)
		throws SystemException {
		for (DictMetaData dictMetaData : findByC_G_DI(companyId, groupId,
				dictDataId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dictMetaData);
		}
	}
	 ...
	 */
	@Override
	public int countByC_G_DI(long companyId, long groupId, long dictDataId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_G_DI;

		Object[] finderArgs = new Object[] { companyId, groupId, dictDataId };
	 ...
	 */
	@Override
	public int filterCountByC_G_DI(long companyId, long groupId, long dictDataId)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByC_G_DI(companyId, groupId, dictDataId);
		}

		StringBundler query = new StringBundler(4);

		query.append(_FILTER_SQL_COUNT_DICTMETADATA_WHERE);
	...
	private static final String _FINDER_COLUMN_C_G_DI_COMPANYID_2 = "dictMetaData.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_DI_GROUPID_2 = "dictMetaData.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_DI_DICTDATAID_2 = "dictMetaData.dictDataId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_G_DI_AN = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, DictMetaDataImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByC_G_DI_AN",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				String.class.getName()
			},
			...
			DictMetaDataModelImpl.DICTDATAID_COLUMN_BITMASK |
			DictMetaDataModelImpl.ATTRIBUTENAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_DI_AN = new FinderPath(DictMetaDataModelImpl.ENTITY_CACHE_ENABLED,
			DictMetaDataModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_G_DI_AN",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public DictMetaData findByC_G_DI_AN(long companyId, long groupId,
		long dictDataId, String attributeName)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = fetchByC_G_DI_AN(companyId, groupId,
				dictDataId, attributeName);
	 ...
	 */
	@Override
	public DictMetaData fetchByC_G_DI_AN(long companyId, long groupId,
		long dictDataId, String attributeName) throws SystemException {
		return fetchByC_G_DI_AN(companyId, groupId, dictDataId, attributeName,
			true);
	}
	...
	@Override
	public DictMetaData fetchByC_G_DI_AN(long companyId, long groupId,
		long dictDataId, String attributeName, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				companyId, groupId, dictDataId, attributeName
			};

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_C_G_DI_AN,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_G_DI_AN_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_G_DI_AN_GROUPID_2);

			query.append(_FINDER_COLUMN_C_G_DI_AN_DICTDATAID_2);

			boolean bindAttributeName = false;

			if (attributeName == null) {
				query.append(_FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_1);
			}
			else if (attributeName.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_3);
			}
			else {
				bindAttributeName = true;

				query.append(_FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_G_DI_AN,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"DictMetaDataPersistenceImpl.fetchByC_G_DI_AN(long, long, long, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((dictMetaData.getCompanyId() != companyId) ||
							(dictMetaData.getGroupId() != groupId) ||
							(dictMetaData.getDictDataId() != dictDataId) ||
							(dictMetaData.getAttributeName() == null) ||
							!dictMetaData.getAttributeName()
											 .equals(attributeName)) {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_G_DI_AN,
					finderArgs);
	 ...
	 */
	@Override
	public DictMetaData removeByC_G_DI_AN(long companyId, long groupId,
		long dictDataId, String attributeName)
		throws NoSuchDictMetaDataException, SystemException {
		DictMetaData dictMetaData = findByC_G_DI_AN(companyId, groupId,
				dictDataId, attributeName);
	 ...
	 */
	@Override
	public int countByC_G_DI_AN(long companyId, long groupId, long dictDataId,
		String attributeName) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_G_DI_AN;
	...
	private static final String _FINDER_COLUMN_C_G_DI_AN_COMPANYID_2 = "dictMetaData.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_DI_AN_GROUPID_2 = "dictMetaData.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_DI_AN_DICTDATAID_2 = "dictMetaData.dictDataId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_1 = "dictMetaData.attributeName IS NULL";
	private static final String _FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_2 = "dictMetaData.attributeName = ?";
	private static final String _FINDER_COLUMN_C_G_DI_AN_ATTRIBUTENAME_3 = "(dictMetaData.attributeName IS NULL OR dictMetaData.attributeName = '')";
	...
	public void cacheResult(DictMetaData dictMetaData) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_G_DI_AN,
			new Object[] {
				dictMetaData.getCompanyId(), dictMetaData.getGroupId(),
				dictMetaData.getDictDataId(), dictMetaData.getAttributeName()
			}, dictMetaData);
	...
	protected void cacheUniqueFindersCache(DictMetaData dictMetaData) {
		if (dictMetaData.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_DI_AN, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_DI_AN, args,
				dictMetaData);
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_G_DI_AN, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_C_G_DI_AN, args,
				dictMetaData);
		}
		else {
			...
			if ((dictMetaDataModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_C_DI_AN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((dictMetaDataModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_C_G_DI_AN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dictMetaData.getCompanyId(), dictMetaData.getGroupId(),
						dictMetaData.getDictDataId(),
						dictMetaData.getAttributeName()
	...
	protected void clearUniqueFindersCache(DictMetaData dictMetaData) {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_DI_AN, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_DI_AN, args);
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_G_DI_AN, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_G_DI_AN, args);

		if ((dictMetaDataModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_C_G_DI_AN.getColumnBitmask()) != 0) {
			args = new Object[] {
					dictMetaDataModelImpl.getOriginalCompanyId(),
					dictMetaDataModelImpl.getOriginalGroupId(),
					dictMetaDataModelImpl.getOriginalDictDataId(),
					dictMetaDataModelImpl.getOriginalAttributeName()
				};
	...
	public DictMetaData updateImpl(
		...
		if (isNew || !DictMetaDataModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dictMetaDataModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_DI.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dictMetaDataModelImpl.getOriginalCompanyId(),
						dictMetaDataModelImpl.getOriginalGroupId(),
						dictMetaDataModelImpl.getOriginalDictDataId()
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_G_DI, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_DI,
					args);

				args = new Object[] {
						dictMetaDataModelImpl.getCompanyId(),
						dictMetaDataModelImpl.getGroupId(),
						dictMetaDataModelImpl.getDictDataId()
					};
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.core.datamgt.model.DictMetaData")));
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "dictMetaData.dictMetaDataId";
	private static final String _FILTER_SQL_SELECT_DICTMETADATA_WHERE = "SELECT DISTINCT {dictMetaData.*} FROM oep_datamgt_dictmetadata dictMetaData WHERE ";
	private static final String _FILTER_SQL_SELECT_DICTMETADATA_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {oep_datamgt_dictmetadata.*} FROM (SELECT DISTINCT dictMetaData.dictMetaDataId FROM oep_datamgt_dictmetadata dictMetaData WHERE ";
	private static final String _FILTER_SQL_SELECT_DICTMETADATA_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN oep_datamgt_dictmetadata ON TEMP_TABLE.dictMetaDataId = oep_datamgt_dictmetadata.dictMetaDataId";
	private static final String _FILTER_SQL_COUNT_DICTMETADATA_WHERE = "SELECT COUNT(DISTINCT dictMetaData.dictMetaDataId) AS COUNT_VALUE FROM oep_datamgt_dictmetadata dictMetaData WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "dictMetaData";
	private static final String _FILTER_ENTITY_TABLE = "oep_datamgt_dictmetadata";
	private static final String _ORDER_BY_ENTITY_ALIAS = "dictMetaData.";
	private static final String _ORDER_BY_ENTITY_TABLE = "oep_datamgt_dictmetadata.";
