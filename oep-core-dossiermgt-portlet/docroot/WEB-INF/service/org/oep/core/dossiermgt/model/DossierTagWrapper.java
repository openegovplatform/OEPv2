...
public class DossierTagWrapper implements DossierTag, ModelWrapper<DossierTag> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.core.dossiermgt.model.DossierTag dossierTag) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.dossiermgt.model.DossierTag> toCacheModel() {
		return _dossierTag.toCacheModel();
	}

	@Override
	public org.oep.core.dossiermgt.model.DossierTag toEscapedModel() {
		return new DossierTagWrapper(_dossierTag.toEscapedModel());
	}

	@Override
	public org.oep.core.dossiermgt.model.DossierTag toUnescapedModel() {
