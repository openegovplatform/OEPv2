...
public class StatisticByDomainWrapper implements StatisticByDomain,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.dossiermgt.model.StatisticByDomain> toCacheModel() {
		return _statisticByDomain.toCacheModel();
	}

	@Override
	public org.oep.core.dossiermgt.model.StatisticByDomain toEscapedModel() {
		return new StatisticByDomainWrapper(_statisticByDomain.toEscapedModel());
	}

	@Override
	public org.oep.core.dossiermgt.model.StatisticByDomain toUnescapedModel() {
