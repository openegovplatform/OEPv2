...
/**
 * The persistence utility for the statistic by day service. This utility wraps {@link StatisticByDayPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class StatisticByDayUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(StatisticByDay statisticByDay) {
		getPersistence().clearCache(statisticByDay);
	}
	 ...
	 */
	public static List<StatisticByDay> findWithDynamicQuery(
	 ...
	 */
	public static StatisticByDay update(StatisticByDay statisticByDay)
		throws SystemException {
		return getPersistence().update(statisticByDay);
	}
	...
	public static StatisticByDay update(StatisticByDay statisticByDay,
		...
		return getPersistence().update(statisticByDay, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(statisticByDay);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<org.oep.core.dossiermgt.model.StatisticByDay> statisticByDaies) {
		getPersistence().cacheResult(statisticByDaies);
	}
	...
	*/
	public static org.oep.core.dossiermgt.model.StatisticByDay create(
		long statisticByDayId) {
		return getPersistence().create(statisticByDayId);
	}
	...
	*/
	public static org.oep.core.dossiermgt.model.StatisticByDay remove(
		long statisticByDayId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.core.dossiermgt.NoSuchStatisticByDayException {
		return getPersistence().remove(statisticByDayId);
	}

	public static org.oep.core.dossiermgt.model.StatisticByDay updateImpl(
		org.oep.core.dossiermgt.model.StatisticByDay statisticByDay)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(statisticByDay);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.dossiermgt.model.StatisticByDay findByPrimaryKey(
		long statisticByDayId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.core.dossiermgt.NoSuchStatisticByDayException {
		return getPersistence().findByPrimaryKey(statisticByDayId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.dossiermgt.model.StatisticByDay fetchByPrimaryKey(
		long statisticByDayId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(statisticByDayId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.core.dossiermgt.model.StatisticByDay> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StatisticByDayPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StatisticByDayPersistence)PortletBeanLocatorUtil.locate(org.oep.core.dossiermgt.service.ClpSerializer.getServletContextName(),
					StatisticByDayPersistence.class.getName());

			ReferenceRegistry.registerReference(StatisticByDayUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(StatisticByDayPersistence persistence) {
	}

	private static StatisticByDayPersistence _persistence;
}