...
import org.oep.core.dossiermgt.service.PaymentFile2DossierLocalService;
...
/**
 * Provides the base implementation for the payment file2 dossier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.dossiermgt.service.impl.PaymentFile2DossierLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class PaymentFile2DossierLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentFile2DossierLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.dossiermgt.service.PaymentFile2DossierLocalServiceUtil} to access the payment file2 dossier local service.
	 */
	...
	@Override
	public PaymentFile2Dossier addPaymentFile2Dossier(
		PaymentFile2Dossier paymentFile2Dossier) throws SystemException {
		paymentFile2Dossier.setNew(true);

		return paymentFile2DossierPersistence.update(paymentFile2Dossier);
	}
	 ...
	 */
	@Override
	public PaymentFile2Dossier createPaymentFile2Dossier(long id) {
		return paymentFile2DossierPersistence.create(id);
	}
	...
	@Override
	public PaymentFile2Dossier deletePaymentFile2Dossier(long id)
		throws PortalException, SystemException {
		return paymentFile2DossierPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentFile2Dossier deletePaymentFile2Dossier(
		PaymentFile2Dossier paymentFile2Dossier) throws SystemException {
		return paymentFile2DossierPersistence.remove(paymentFile2Dossier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentFile2Dossier.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentFile2DossierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentFile2DossierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentFile2Dossier fetchPaymentFile2Dossier(long id)
		throws SystemException {
		return paymentFile2DossierPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public PaymentFile2Dossier getPaymentFile2Dossier(long id)
		throws PortalException, SystemException {
		return paymentFile2DossierPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentFile2DossierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentFile2Dossier> getPaymentFile2Dossiers(int start, int end)
		throws SystemException {
		return paymentFile2DossierPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentFile2DossiersCount() throws SystemException {
		return paymentFile2DossierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentFile2Dossier updatePaymentFile2Dossier(
		PaymentFile2Dossier paymentFile2Dossier) throws SystemException {
		return paymentFile2DossierPersistence.update(paymentFile2Dossier);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.dossiermgt.model.PaymentFile2Dossier",
			paymentFile2DossierLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentFile2DossierPersistence.getDataSource();
	...
	private PaymentFile2DossierLocalServiceClpInvoker _clpInvoker = new PaymentFile2DossierLocalServiceClpInvoker();
}