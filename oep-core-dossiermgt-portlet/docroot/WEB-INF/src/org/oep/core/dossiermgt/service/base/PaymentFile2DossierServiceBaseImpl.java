...
import org.oep.core.dossiermgt.service.PaymentFile2DossierService;
...
/**
 * Provides the base implementation for the payment file2 dossier remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.dossiermgt.service.impl.PaymentFile2DossierServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class PaymentFile2DossierServiceBaseImpl extends BaseServiceImpl
	implements PaymentFile2DossierService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.dossiermgt.service.PaymentFile2DossierServiceUtil} to access the payment file2 dossier remote service.
	 */
	...
	private PaymentFile2DossierServiceClpInvoker _clpInvoker = new PaymentFile2DossierServiceClpInvoker();
}