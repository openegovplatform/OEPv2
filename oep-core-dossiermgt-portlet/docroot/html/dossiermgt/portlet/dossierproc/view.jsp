...
<aui:form action="<%= dossierProcSearchURL %>" method="POST" name="searchDossierProc">
	<aui:row>
		<aui:column columnWidth="50">
			<aui:input type="text" name="name" id="name" label="<%= LanguageUtil.get(pageContext, \"org.oep.core.dossiermgt.portlet.dossierproc.label.name\") %>"></aui:input>
		</aui:column>
		<aui:column columnWidth="50">
			<aui:select name="domainNo" id="domainNo" label="<%= LanguageUtil.get(pageContext, \"org.oep.core.dossiermgt.portlet.dossierproc.label.domainno\") %>">
				<aui:option value=""><%= LanguageUtil.get(pageContext, "org.oep.core.dossiermgt.portlet.dossierproc.label.search.alldomainno") %></aui:option>
			<%
				...
				List<DictData> lstDomainData = DictDataLocalServiceUtil.getByTreeLevel("OEP_DOSSIER_DOMAIN", 0, totalDomain, serviceContext);
				String l1 = "";
				String l2 = "&nbsp;&nbsp;&nbsp;&nbsp;";
				String l3 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				String l4 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	...
	<aui:row>
		<aui:column columnWidth="50">
			<%
				int totalDictData = DictDataLocalServiceUtil.countDictDataByTreeLevel("OEP_DOSSIER_ADMINISTRATION", serviceContext);
			
				List<DictData> lstDictData = DictDataLocalServiceUtil.getByTreeLevel("OEP_DOSSIER_ADMINISTRATION", 0, totalDictData, serviceContext);
				String l1 = "";
				String l2 = "&nbsp;&nbsp;&nbsp;&nbsp;";
				String l3 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				String l4 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
			...
			<aui:select name="administrationNo" id="administrationNo" label="<%= LanguageUtil.get(pageContext, \"org.oep.core.dossiermgt.portlet.dossierproc.label.administrationno\") %>">
			<aui:option value=""><%= LanguageUtil.get(pageContext, "org.oep.core.dossiermgt.portlet.dossierproc.label.search.alladministrationno") %></aui:option>
			<%
		...
		<aui:column columnWidth="50">
			<input type="button" onclick="<portlet:namespace/>search()" class="btn primary" value="<liferay-ui:message key="org.oep.core.dossiermgt.portlet.dossierproc.button.search"/>"/>
		</aui:column>		
	</aui:row>
	...
	<aui:row>
		<aui:column columnWidth="100">
			<table class="table">
				<thead>
					<tr>
						<th><%= LanguageUtil.get(pageContext, "org.oep.core.dossiermgt.portlet.dossierproc.label.table.header.stt") %></th>
						<th><%= LanguageUtil.get(pageContext, "org.oep.core.dossiermgt.portlet.dossierproc.label.table.header.name") %></th>
						<th><%= LanguageUtil.get(pageContext, "org.oep.core.dossiermgt.portlet.dossierproc.label.table.header.administrationname") %></th>
					</tr>
				</thead>
				<tbody>
				<%
