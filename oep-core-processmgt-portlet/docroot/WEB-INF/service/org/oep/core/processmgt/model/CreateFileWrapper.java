...
public class CreateFileWrapper implements CreateFile, ModelWrapper<CreateFile> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.core.processmgt.model.CreateFile createFile) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.processmgt.model.CreateFile> toCacheModel() {
		return _createFile.toCacheModel();
	}

	@Override
	public org.oep.core.processmgt.model.CreateFile toEscapedModel() {
		return new CreateFileWrapper(_createFile.toEscapedModel());
	}

	@Override
	public org.oep.core.processmgt.model.CreateFile toUnescapedModel() {
