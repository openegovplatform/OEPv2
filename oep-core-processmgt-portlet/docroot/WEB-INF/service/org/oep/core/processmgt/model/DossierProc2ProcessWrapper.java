...
public class DossierProc2ProcessWrapper implements DossierProc2Process,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.processmgt.model.DossierProc2Process> toCacheModel() {
		return _dossierProc2Process.toCacheModel();
	}

	@Override
	public org.oep.core.processmgt.model.DossierProc2Process toEscapedModel() {
		return new DossierProc2ProcessWrapper(_dossierProc2Process.toEscapedModel());
	}

	@Override
	public org.oep.core.processmgt.model.DossierProc2Process toUnescapedModel() {
