...
public class DossierStepWrapper implements DossierStep,
	...
	*/
	...
	@Override
	public int compareTo(org.oep.core.processmgt.model.DossierStep dossierStep) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.processmgt.model.DossierStep> toCacheModel() {
		return _dossierStep.toCacheModel();
	}

	@Override
	public org.oep.core.processmgt.model.DossierStep toEscapedModel() {
		return new DossierStepWrapper(_dossierStep.toEscapedModel());
	}

	@Override
	public org.oep.core.processmgt.model.DossierStep toUnescapedModel() {
