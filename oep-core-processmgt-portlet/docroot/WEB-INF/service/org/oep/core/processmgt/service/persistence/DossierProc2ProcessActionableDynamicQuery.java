 ...
 * @generated
 */
public abstract class DossierProc2ProcessActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DossierProc2ProcessActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(DossierProc2ProcessLocalServiceUtil.getService());
		setClass(DossierProc2Process.class);

		setClassLoader(org.oep.core.processmgt.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("dossierProc2ProcessId");
	}
}