...
import org.oep.core.processmgt.service.DossierProc2ProcessLocalService;
...
/**
 * Provides the base implementation for the dossier proc2 process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.processmgt.service.impl.DossierProc2ProcessLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierProc2ProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierProc2ProcessLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.processmgt.service.DossierProc2ProcessLocalServiceUtil} to access the dossier proc2 process local service.
	 */
	...
	public DossierProc2Process addDossierProc2Process(
		...
		return dossierProc2ProcessPersistence.update(dossierProc2Process);
	}
	 ...
	 */
	@Override
	public DossierProc2Process createDossierProc2Process(
		long dossierProc2ProcessId) {
		return dossierProc2ProcessPersistence.create(dossierProc2ProcessId);
	}
	...
	@Override
	public DossierProc2Process deleteDossierProc2Process(
		long dossierProc2ProcessId) throws PortalException, SystemException {
		return dossierProc2ProcessPersistence.remove(dossierProc2ProcessId);
	}
	...
	public DossierProc2Process deleteDossierProc2Process(
		DossierProc2Process dossierProc2Process) throws SystemException {
		return dossierProc2ProcessPersistence.remove(dossierProc2Process);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierProc2Process.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dossierProc2ProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dossierProc2ProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DossierProc2Process fetchDossierProc2Process(
		long dossierProc2ProcessId) throws SystemException {
		return dossierProc2ProcessPersistence.fetchByPrimaryKey(dossierProc2ProcessId);
	}
	 ...
	 */
	@Override
	public DossierProc2Process getDossierProc2Process(
		long dossierProc2ProcessId) throws PortalException, SystemException {
		return dossierProc2ProcessPersistence.findByPrimaryKey(dossierProc2ProcessId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dossierProc2ProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierProc2Process> getDossierProc2Processes(int start, int end)
		throws SystemException {
		return dossierProc2ProcessPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDossierProc2ProcessesCount() throws SystemException {
		return dossierProc2ProcessPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.processmgt.model.DossierProc2Process",
			dossierProc2ProcessLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dossierProc2ProcessPersistence.getDataSource();
	...
	private DossierProc2ProcessLocalServiceClpInvoker _clpInvoker = new DossierProc2ProcessLocalServiceClpInvoker();
}