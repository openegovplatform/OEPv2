...
public class DossierProc2ProcessLocalServiceClpInvoker {
	public DossierProc2ProcessLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"org.oep.core.processmgt.model.DossierProc2Process"
			};
		...
		_methodName112 = "addDossierProc2Process";
		...
		_methodName113 = "updateDossierProc2Process";
		...
		_methodName114 = "updateDossierProc2Process";
		...
		_methodName116 = "removeDossierProc2Process";

		_methodParameterTypes116 = new String[] {
				"org.oep.core.processmgt.model.DossierProc2Process"
			};

		_methodName117 = "removeDossierProc2Process";

		_methodParameterTypes117 = new String[] { "long" };

		_methodName118 = "getDossierProc2Process";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DossierProc2ProcessLocalServiceUtil.addDossierProc2Process((org.oep.core.processmgt.model.DossierProc2Process)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DossierProc2ProcessLocalServiceUtil.deleteDossierProc2Process((org.oep.core.processmgt.model.DossierProc2Process)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return DossierProc2ProcessLocalServiceUtil.updateDossierProc2Process((org.oep.core.processmgt.model.DossierProc2Process)arguments[0]);
		}
		...
		if (_methodName116.equals(name) &&
			...
			DossierProc2ProcessLocalServiceUtil.removeDossierProc2Process((org.oep.core.processmgt.model.DossierProc2Process)arguments[0]);
