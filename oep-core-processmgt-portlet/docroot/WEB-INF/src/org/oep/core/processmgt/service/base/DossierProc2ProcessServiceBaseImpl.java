...
import org.oep.core.processmgt.service.DossierProc2ProcessService;
...
/**
 * Provides the base implementation for the dossier proc2 process remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.processmgt.service.impl.DossierProc2ProcessServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierProc2ProcessServiceBaseImpl extends BaseServiceImpl
	implements DossierProc2ProcessService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.processmgt.service.DossierProc2ProcessServiceUtil} to access the dossier proc2 process remote service.
	 */
	...
	private DossierProc2ProcessServiceClpInvoker _clpInvoker = new DossierProc2ProcessServiceClpInvoker();
}