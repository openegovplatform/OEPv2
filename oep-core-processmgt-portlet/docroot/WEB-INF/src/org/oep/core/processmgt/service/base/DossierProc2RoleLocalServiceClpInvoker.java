...
public class DossierProc2RoleLocalServiceClpInvoker {
	public DossierProc2RoleLocalServiceClpInvoker() {
		...
		_methodName112 = "addDossierProc2Role";

		_methodParameterTypes112 = new String[] {
				"long", "long", "com.liferay.portal.service.ServiceContext"
			};

		_methodName113 = "removeDossierProc2Role";

		_methodParameterTypes113 = new String[] {
				"org.oep.core.processmgt.model.DossierProc2Role"
			};

		_methodName114 = "removeDossierProc2Role";

		_methodParameterTypes114 = new String[] { "long" };

		_methodName115 = "getDossierProc2Role";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DossierProc2RoleLocalServiceUtil.addDossierProc2Role((org.oep.core.processmgt.model.DossierProc2Role)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DossierProc2RoleLocalServiceUtil.deleteDossierProc2Role((org.oep.core.processmgt.model.DossierProc2Role)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return DossierProc2RoleLocalServiceUtil.updateDossierProc2Role((org.oep.core.processmgt.model.DossierProc2Role)arguments[0]);
		}
		...
		if (_methodName113.equals(name) &&
			...
			DossierProc2RoleLocalServiceUtil.removeDossierProc2Role((org.oep.core.processmgt.model.DossierProc2Role)arguments[0]);
