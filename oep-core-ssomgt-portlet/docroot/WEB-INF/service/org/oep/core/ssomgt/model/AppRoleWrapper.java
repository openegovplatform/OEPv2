...
public class AppRoleWrapper implements AppRole, ModelWrapper<AppRole> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.core.ssomgt.model.AppRole appRole) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.core.ssomgt.model.AppRole> toCacheModel() {
		return _appRole.toCacheModel();
	}

	@Override
	public org.oep.core.ssomgt.model.AppRole toEscapedModel() {
		return new AppRoleWrapper(_appRole.toEscapedModel());
	}

	@Override
	public org.oep.core.ssomgt.model.AppRole toUnescapedModel() {
