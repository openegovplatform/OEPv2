...
public interface UserSyncLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserSyncLocalServiceUtil} to access the user sync local service. Add custom service methods to {@link org.oep.core.ssomgt.service.impl.UserSyncLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
