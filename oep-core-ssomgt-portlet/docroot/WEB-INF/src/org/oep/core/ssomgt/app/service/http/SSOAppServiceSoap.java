...
package org.oep.core.ssomgt.app.service.http;
 ...
 * {@link org.oep.core.ssomgt.app.service.SSOAppServiceUtil} service utility. The
...
public class SSOAppServiceSoap {
	public static org.oep.core.ssomgt.model.AppMessage newMessage(long userId,
		...
		java.lang.String messageUrl) throws RemoteException {
		try {
			org.oep.core.ssomgt.model.AppMessage returnValue = SSOAppServiceUtil.newMessage(userId,
					appCode, appPin, createDate, toUser, messageType,
					messageCode, messageText, messageValue, messageUrl);
