...
import org.oep.core.ssomgt.model.AppMessageModel;
import org.oep.core.ssomgt.model.AppMessageSoap;
...
/**
 * The base model implementation for the AppMessage service. Represents a row in the &quot;oep_ssomgt_appmessage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link org.oep.core.ssomgt.model.AppMessageModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AppMessageImpl}.
 * </p>
 *
 * @author trungdk
 * @see AppMessageImpl
 * @see org.oep.core.ssomgt.model.AppMessage
 * @see org.oep.core.ssomgt.model.AppMessageModel
 * @generated
 */
@JSON(strict = true)
public class AppMessageModelImpl extends BaseModelImpl<AppMessage>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a app message model instance should use the {@link org.oep.core.ssomgt.model.AppMessage} interface instead.
	 */
	public static final String TABLE_NAME = "oep_ssomgt_appmessage";
	...
	public static final String TABLE_SQL_CREATE = "create table oep_ssomgt_appmessage (appMessageId LONG not null primary key,userId LONG,groupId LONG,companyId LONG,createDate DATE null,fromApplication VARCHAR(30) null,toUser VARCHAR(30) null,messageType VARCHAR(30) null,messageCode VARCHAR(30) null,messageText VARCHAR(200) null,messageValue VARCHAR(200) null,messageUrl VARCHAR(200) null,visitDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table oep_ssomgt_appmessage";
	public static final String ORDER_BY_JPQL = " ORDER BY appMessage.appMessageId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY oep_ssomgt_appmessage.appMessageId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.org.oep.core.ssomgt.model.AppMessage"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.org.oep.core.ssomgt.model.AppMessage"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.oep.core.ssomgt.model.AppMessage"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.org.oep.core.ssomgt.model.AppMessage"));
