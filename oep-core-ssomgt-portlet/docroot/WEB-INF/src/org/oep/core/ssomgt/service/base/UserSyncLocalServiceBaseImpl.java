...
import org.oep.core.ssomgt.service.UserSyncLocalService;
...
/**
 * Provides the base implementation for the user sync local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.ssomgt.service.impl.UserSyncLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class UserSyncLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserSyncLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.ssomgt.service.UserSyncLocalServiceUtil} to access the user sync local service.
	 */
	...
	@Override
	public UserSync addUserSync(UserSync userSync) throws SystemException {
		userSync.setNew(true);

		return userSyncPersistence.update(userSync);
	}
	 ...
	 */
	@Override
	public UserSync createUserSync(long userSyncId) {
		return userSyncPersistence.create(userSyncId);
	}
	...
	@Override
	public UserSync deleteUserSync(long userSyncId)
		throws PortalException, SystemException {
		return userSyncPersistence.remove(userSyncId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserSync deleteUserSync(UserSync userSync) throws SystemException {
		return userSyncPersistence.remove(userSync);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserSync.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userSyncPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userSyncPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return userSyncPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSyncPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserSync fetchUserSync(long userSyncId) throws SystemException {
		return userSyncPersistence.fetchByPrimaryKey(userSyncId);
	}
	 ...
	 */
	@Override
	public UserSync getUserSync(long userSyncId)
		throws PortalException, SystemException {
		return userSyncPersistence.findByPrimaryKey(userSyncId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userSyncPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserSync> getUserSyncs(int start, int end)
		throws SystemException {
		return userSyncPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserSyncsCount() throws SystemException {
		return userSyncPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserSync updateUserSync(UserSync userSync) throws SystemException {
		return userSyncPersistence.update(userSync);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.ssomgt.model.UserSync",
			userSyncLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userSyncPersistence.getDataSource();
	...
	private UserSyncLocalServiceClpInvoker _clpInvoker = new UserSyncLocalServiceClpInvoker();
}