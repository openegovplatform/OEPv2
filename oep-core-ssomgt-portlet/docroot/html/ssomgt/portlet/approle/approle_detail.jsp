...
<portlet:actionURL var="addEditAppRole" name="addEditAppRole">
	<portlet:param name="<%= PortletKeys.SET_VIEW_PARAMETER %>" value="/html/ssomgt/portlet/approle/appro;e_detail.jsp"/>
...
<aui:form name="addEditAppRoleForm" method="post">
	<div class="form-group">
		...
		<aui:row>
			<aui:column columnWidth="50">
				<aui:input style="width: 100%;" label="<%= LanguageUtil.get(pageContext, \"org.oep.ssomgt.portlet.approle.label.rolecode\") %>" name="<%= AppRoleKeys.AddEditAttributes.ROLE_CODE %>" id="<%= AppRoleKeys.AddEditAttributes.ROLE_CODE %>" type="text"></aui:input>
			</aui:column>			
		</aui:row>
		<aui:row>
			<aui:column columnWidth="50">
				<aui:input style="width: 100%;" label="<%= LanguageUtil.get(pageContext, \"org.oep.ssomgt.portlet.approle.label.rolename\") %>" name="<%= AppRoleKeys.AddEditAttributes.ROLE_NAME %>" id="<%= AppRoleKeys.AddEditAttributes.ROLE_NAME %>" type="text"></aui:input>
			</aui:column>	
		</aui:row>
		<aui:row>
			<aui:column>
