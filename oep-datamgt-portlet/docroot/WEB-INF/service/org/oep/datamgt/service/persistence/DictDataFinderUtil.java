...
public class DictDataFinderUtil {
	...
	public static int countByDataLevelDataCode(java.lang.String dataCode,
		java.lang.String collectionName, java.lang.String dataCodeParent,
		int datalevel, com.liferay.portal.service.ServiceContext serviceContext) {
		return getFinder()
				   .countByDataLevelDataCode(dataCode, collectionName,
			dataCodeParent, datalevel, serviceContext);
	}

	public static DictDataFinder getFinder() {
		if (_finder == null) {
			_finder = (DictDataFinder)PortletBeanLocatorUtil.locate(org.oep.datamgt.service.ClpSerializer.getServletContextName(),
