...
/**
 * The extended model base implementation for the DictCollection service. Represents a row in the &quot;oep_datamgt_dictcollection&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public abstract class DictCollectionBaseImpl extends DictCollectionModelImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dictionary collection model instance should use the {@link DictCollection} interface instead.
	 */
	@Override
