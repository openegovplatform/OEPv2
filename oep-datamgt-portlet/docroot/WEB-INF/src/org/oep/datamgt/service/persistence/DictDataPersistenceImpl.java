...
import org.oep.datamgt.NoSuchDictDataException;
import org.oep.datamgt.model.DictData;
import org.oep.datamgt.model.impl.DictDataImpl;
import org.oep.datamgt.model.impl.DictDataModelImpl;
...
public class DictDataPersistenceImpl extends BasePersistenceImpl<DictData>
	...
	@Override
	public DictData updateImpl(org.oep.datamgt.model.DictData dictData)
		throws SystemException {
		dictData = toUnwrappedModel(dictData);
	 ...
	 */
	@Override
	public List<org.oep.datamgt.model.DictCollection> getDictCollections(
	...
	public void addDictCollections(long pk,
		List<org.oep.datamgt.model.DictCollection> dictCollections)
		throws SystemException {
		for (org.oep.datamgt.model.DictCollection dictCollection : dictCollections) {
			dictDataToDictCollectionTableMapper.addTableMapping(pk,
				dictCollection.getPrimaryKey());
		}
	}
	...
	public void setDictCollections(long pk,
		...
		try {
			...
			for (int i = 0; i < dictCollections.size(); i++) {
				org.oep.datamgt.model.DictCollection dictCollection = dictCollections.get(i);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.datamgt.model.DictData")));
	...
	protected TableMapper<DictData, org.oep.datamgt.model.DictCollection> dictDataToDictCollectionTableMapper;
