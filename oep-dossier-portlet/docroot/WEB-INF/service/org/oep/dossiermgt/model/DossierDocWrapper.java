...
public class DossierDocWrapper implements DossierDoc, ModelWrapper<DossierDoc> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.DossierDoc dossierDoc) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.DossierDoc> toCacheModel() {
		return _dossierDoc.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.DossierDoc toEscapedModel() {
		return new DossierDocWrapper(_dossierDoc.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.DossierDoc toUnescapedModel() {
