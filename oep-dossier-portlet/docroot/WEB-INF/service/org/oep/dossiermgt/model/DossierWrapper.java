...
public class DossierWrapper implements Dossier, ModelWrapper<Dossier> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.Dossier dossier) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.Dossier> toCacheModel() {
		return _dossier.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.Dossier toEscapedModel() {
		return new DossierWrapper(_dossier.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.Dossier toUnescapedModel() {
