...
public class EbMessageWrapper implements EbMessage, ModelWrapper<EbMessage> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.EbMessage ebMessage) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.EbMessage> toCacheModel() {
		return _ebMessage.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.EbMessage toEscapedModel() {
		return new EbMessageWrapper(_ebMessage.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.EbMessage toUnescapedModel() {
