...
public class EbPartnerShipWrapper implements EbPartnerShip,
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.EbPartnerShip ebPartnerShip) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.EbPartnerShip> toCacheModel() {
		return _ebPartnerShip.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.EbPartnerShip toEscapedModel() {
		return new EbPartnerShipWrapper(_ebPartnerShip.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.EbPartnerShip toUnescapedModel() {
