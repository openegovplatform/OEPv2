...
public class PaymentConfigWrapper implements PaymentConfig,
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.PaymentConfig paymentConfig) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.PaymentConfig> toCacheModel() {
		return _paymentConfig.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.PaymentConfig toEscapedModel() {
		return new PaymentConfigWrapper(_paymentConfig.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.PaymentConfig toUnescapedModel() {
