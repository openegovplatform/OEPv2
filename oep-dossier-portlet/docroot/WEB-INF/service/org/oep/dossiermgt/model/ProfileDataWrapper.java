...
public class ProfileDataWrapper implements ProfileData,
	...
	*/
	...
	@Override
	public int compareTo(org.oep.dossiermgt.model.ProfileData profileData) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.ProfileData> toCacheModel() {
		return _profileData.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.ProfileData toEscapedModel() {
		return new ProfileDataWrapper(_profileData.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.ProfileData toUnescapedModel() {
