...
public class StatisticByAgencyWrapper implements StatisticByAgency,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.dossiermgt.model.StatisticByAgency> toCacheModel() {
		return _statisticByAgency.toCacheModel();
	}

	@Override
	public org.oep.dossiermgt.model.StatisticByAgency toEscapedModel() {
		return new StatisticByAgencyWrapper(_statisticByAgency.toEscapedModel());
	}

	@Override
	public org.oep.dossiermgt.model.StatisticByAgency toUnescapedModel() {
