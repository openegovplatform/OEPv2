...
/**
 * Provides the local service interface for DocTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see DocTemplateLocalServiceUtil
 * @see org.oep.dossiermgt.service.base.DocTemplateLocalServiceBaseImpl
 * @see org.oep.dossiermgt.service.impl.DocTemplateLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface DocTemplateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocTemplateLocalServiceUtil} to access the doc template local service. Add custom service methods to {@link org.oep.dossiermgt.service.impl.DocTemplateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public org.oep.dossiermgt.model.DocTemplate addDocTemplate(
	...
	*/
	public org.oep.dossiermgt.model.DocTemplate createDocTemplate(
		long docTemplateId);
	...
	*/
	...
	public org.oep.dossiermgt.model.DocTemplate deleteDocTemplate(
		long docTemplateId)
	...
	*/
	...
	public org.oep.dossiermgt.model.DocTemplate fetchDocTemplate(
		long docTemplateId)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public org.oep.dossiermgt.model.DocTemplate getDocTemplate(
		long docTemplateId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<org.oep.dossiermgt.model.DocTemplate> getDocTemplates(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.dossiermgt.model.DocTemplate updateDocTemplate(
		org.oep.dossiermgt.model.DocTemplate docTemplate)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<org.oep.dossiermgt.model.DocTemplate> getDossierDocDocTemplates(
		long dossierDocId)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	...
	/**
	* ThÃªm má»™t biá»ƒu máº«u tÃ i liá»‡u
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*
	* @param templateNo mÃ£ biá»ƒu máº«u
	* @param title TiÃªu Ä‘á»� biá»ƒu máº«u
	* @param enTitle TiÃªu Ä‘á»� Tiáº¿ng Anh cá»§a biá»ƒu máº«u
	* @param fileEntryId MÃ£ tÃ i liá»‡u máº«u báº±ng module quáº£n lÃ½ phÆ°Æ¡ng tiá»‡n
	* @return: biá»ƒu máº«u tÃ i liá»‡u má»›i táº¡o
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.dossiermgt.model.DocTemplate addDocTemplate(
	...
	/**
	* Sá»­a thÃ´ng tin má»™t biá»ƒu máº«u tÃ i liá»‡u
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param id mÃ£ tá»± tÄƒng biá»ƒu máº«u
	* @param templateNo mÃ£ biá»ƒu máº«u
	* @param title TiÃªu Ä‘á»� biá»ƒu máº«u
	* @param enTitle TiÃªu Ä‘á»� Tiáº¿ng Anh cá»§a biá»ƒu máº«u
	* @param fileEntryId MÃ£ tÃ i liá»‡u máº«u báº±ng module quáº£n lÃ½ phÆ°Æ¡ng tiá»‡n
	* @return: biá»ƒu máº«u tÃ i liá»‡u Ä‘Æ°á»£c sá»­a
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.dossiermgt.model.DocTemplate updateDocTemplate(long id,
		java.lang.String templateNo, java.lang.String title,
		java.lang.String enTitle, long fileEntryId,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
	...
	/**
	* XÃ³a thÃ´ng tin biá»ƒu máº«u tÃ i liá»‡u
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param docTemplate Ä‘á»‘i tÆ°á»£ng biá»ƒu máº«u cáº§n xÃ³a
	* @return
	*/
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param id mÃ£ tá»± tÄƒng biá»ƒu máº«u cáº§n xÃ³a
	* @return
	*/
	...
	*/
	public java.util.List<org.oep.dossiermgt.model.DocTemplate> findByLikeTitle(
	...
	* @return danh sÃ¡ch biá»ƒu máº«u tÃ i liá»‡u
	*/
	public java.util.List<org.oep.dossiermgt.model.DocTemplate> findByGroupLikeTitle(
		java.lang.String title, int startIndex, int endIndex,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.SystemException;
