...
/**
 * Provides the local service interface for DossierDoc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see DossierDocLocalServiceUtil
...
public interface DossierDocLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DossierDocLocalServiceUtil} to access the dossier doc local service. Add custom service methods to {@link org.oep.dossiermgt.service.impl.DossierDocLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
