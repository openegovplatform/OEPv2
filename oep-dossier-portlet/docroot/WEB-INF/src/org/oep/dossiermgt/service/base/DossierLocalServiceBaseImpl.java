...
import org.oep.dossiermgt.service.DossierLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.dossiermgt.service.impl.DossierLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
...
public abstract class DossierLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.dossiermgt.service.DossierLocalServiceUtil} to access the dossier local service.
	 */
	 ...
	 */
	@Override
	public Dossier fetchDossierByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return dossierPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public Dossier getDossierByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return dossierPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.dossiermgt.model.Dossier",
			dossierLocalService);
	}
