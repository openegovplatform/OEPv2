...
public class DossierLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DossierLocalServiceUtil.addDossier((org.oep.dossiermgt.model.Dossier)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DossierLocalServiceUtil.deleteDossier((org.oep.dossiermgt.model.Dossier)arguments[0]);
		}
		...
		if (_methodName19.equals(name) &&
			...
			return DossierLocalServiceUtil.updateDossier((org.oep.dossiermgt.model.Dossier)arguments[0]);
		}
		...
		if (_methodName164.equals(name) &&
			...
			DossierLocalServiceUtil.updateDossierResources((org.oep.dossiermgt.model.Dossier)arguments[0],
		...
		if (_methodName165.equals(name) &&
			...
			DossierLocalServiceUtil.removeDossier((org.oep.dossiermgt.model.Dossier)arguments[0]);
		...
		if (_methodName168.equals(name) &&
			...
			DossierLocalServiceUtil.addDossierResources((org.oep.dossiermgt.model.Dossier)arguments[0],
