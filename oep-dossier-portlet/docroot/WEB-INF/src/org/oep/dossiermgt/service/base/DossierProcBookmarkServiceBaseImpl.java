...
import org.oep.dossiermgt.service.DossierProcBookmarkService;
...
/**
 * Provides the base implementation for the dossier proc bookmark remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.dossiermgt.service.impl.DossierProcBookmarkServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierProcBookmarkServiceBaseImpl extends BaseServiceImpl
	implements DossierProcBookmarkService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.dossiermgt.service.DossierProcBookmarkServiceUtil} to access the dossier proc bookmark remote service.
	 */
	...
	private DossierProcBookmarkServiceClpInvoker _clpInvoker = new DossierProcBookmarkServiceClpInvoker();
}