...
import org.oep.dossiermgt.NoSuchDocTemplateException;
import org.oep.dossiermgt.model.DocTemplate;
import org.oep.dossiermgt.model.impl.DocTemplateImpl;
import org.oep.dossiermgt.model.impl.DocTemplateModelImpl;
...
public class DocTemplatePersistenceImpl extends BasePersistenceImpl<DocTemplate>
	 ...
	 */
	@Override
	public List<org.oep.dossiermgt.model.DossierDoc> getDossierDocs(long pk)
		throws SystemException {
	...
	public void addDossierDocs(long pk,
		List<org.oep.dossiermgt.model.DossierDoc> dossierDocs)
		throws SystemException {
		for (org.oep.dossiermgt.model.DossierDoc dossierDoc : dossierDocs) {
			docTemplateToDossierDocTableMapper.addTableMapping(pk,
				dossierDoc.getPrimaryKey());
		}
	}
	...
	public void setDossierDocs(long pk,
		...
		try {
			...
			for (int i = 0; i < dossierDocs.size(); i++) {
				org.oep.dossiermgt.model.DossierDoc dossierDoc = dossierDocs.get(i);
	...
	protected TableMapper<DocTemplate, org.oep.dossiermgt.model.DossierDoc> docTemplateToDossierDocTableMapper;
