...
import org.oep.dossiermgt.NoSuchDossierDocException;
import org.oep.dossiermgt.model.DossierDoc;
import org.oep.dossiermgt.model.impl.DossierDocImpl;
import org.oep.dossiermgt.model.impl.DossierDocModelImpl;
...
public class DossierDocPersistenceImpl extends BasePersistenceImpl<DossierDoc>
	...
	@Override
	public DossierDoc updateImpl(org.oep.dossiermgt.model.DossierDoc dossierDoc)
		throws SystemException {
		dossierDoc = toUnwrappedModel(dossierDoc);
	 ...
	 */
	@Override
	public List<org.oep.dossiermgt.model.DocTemplate> getDocTemplates(long pk)
		throws SystemException {
	...
	public void addDocTemplates(long pk,
		List<org.oep.dossiermgt.model.DocTemplate> docTemplates)
		throws SystemException {
		for (org.oep.dossiermgt.model.DocTemplate docTemplate : docTemplates) {
			dossierDocToDocTemplateTableMapper.addTableMapping(pk,
				docTemplate.getPrimaryKey());
		}
	}
	...
	public void setDocTemplates(long pk,
		...
		try {
			...
			for (int i = 0; i < docTemplates.size(); i++) {
				org.oep.dossiermgt.model.DocTemplate docTemplate = docTemplates.get(i);
	...
	protected TableMapper<DossierDoc, org.oep.dossiermgt.model.DocTemplate> dossierDocToDocTemplateTableMapper;
