...
import org.oep.dossiermgt.NoSuchPaymentConfigException;
import org.oep.dossiermgt.model.PaymentConfig;
import org.oep.dossiermgt.model.impl.PaymentConfigImpl;
import org.oep.dossiermgt.model.impl.PaymentConfigModelImpl;
...
public class PaymentConfigPersistenceImpl extends BasePersistenceImpl<PaymentConfig>
	...
	protected PaymentConfig toUnwrappedModel(PaymentConfig paymentConfig) {
		...
		paymentConfigImpl.setGovAgencyId(paymentConfig.getGovAgencyId());
