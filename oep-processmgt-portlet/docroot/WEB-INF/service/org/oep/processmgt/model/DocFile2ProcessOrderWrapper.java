...
public class DocFile2ProcessOrderWrapper implements DocFile2ProcessOrder,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.processmgt.model.DocFile2ProcessOrder> toCacheModel() {
		return _docFile2ProcessOrder.toCacheModel();
	}

	@Override
	public org.oep.processmgt.model.DocFile2ProcessOrder toEscapedModel() {
		return new DocFile2ProcessOrderWrapper(_docFile2ProcessOrder.toEscapedModel());
	}

	@Override
	public org.oep.processmgt.model.DocFile2ProcessOrder toUnescapedModel() {
