...
public class ProcessOrderWrapper implements ProcessOrder,
	...
	*/
	...
	@Override
	public int compareTo(org.oep.processmgt.model.ProcessOrder processOrder) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.processmgt.model.ProcessOrder> toCacheModel() {
		return _processOrder.toCacheModel();
	}

	@Override
	public org.oep.processmgt.model.ProcessOrder toEscapedModel() {
		return new ProcessOrderWrapper(_processOrder.toEscapedModel());
	}

	@Override
	public org.oep.processmgt.model.ProcessOrder toUnescapedModel() {
