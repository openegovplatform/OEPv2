...
public class TransitionHistoryWrapper implements TransitionHistory,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.processmgt.model.TransitionHistory> toCacheModel() {
		return _transitionHistory.toCacheModel();
	}

	@Override
	public org.oep.processmgt.model.TransitionHistory toEscapedModel() {
		return new TransitionHistoryWrapper(_transitionHistory.toEscapedModel());
	}

	@Override
	public org.oep.processmgt.model.TransitionHistory toUnescapedModel() {
