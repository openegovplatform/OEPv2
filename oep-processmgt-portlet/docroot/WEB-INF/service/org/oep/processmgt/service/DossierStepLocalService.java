...
/**
 * Provides the local service interface for DossierStep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see DossierStepLocalServiceUtil
...
public interface DossierStepLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DossierStepLocalServiceUtil} to access the dossier step local service. Add custom service methods to {@link org.oep.processmgt.service.impl.DossierStepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
