...
/**
 * Provides the local service interface for StepTransition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see StepTransitionLocalServiceUtil
...
public interface StepTransitionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StepTransitionLocalServiceUtil} to access the step transition local service. Add custom service methods to {@link org.oep.processmgt.service.impl.StepTransitionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
