...
/**
 * The persistence utility for the create file service. This utility wraps {@link CreateFilePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CreateFileUtil {
	 ...
	 */
	public static void clearCache(CreateFile createFile) {
		getPersistence().clearCache(createFile);
	}
	 ...
	 */
	public static List<CreateFile> findWithDynamicQuery(
	 ...
	 */
	public static CreateFile update(CreateFile createFile)
		throws SystemException {
		return getPersistence().update(createFile);
	}
	...
	public static CreateFile update(CreateFile createFile,
		...
		return getPersistence().update(createFile, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(createFile);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<org.oep.processmgt.model.CreateFile> createFiles) {
		getPersistence().cacheResult(createFiles);
	}
	...
	*/
	public static org.oep.processmgt.model.CreateFile create(long createFileId) {
		return getPersistence().create(createFileId);
	}
	...
	*/
	public static org.oep.processmgt.model.CreateFile remove(long createFileId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.processmgt.NoSuchCreateFileException {
		return getPersistence().remove(createFileId);
	}

	public static org.oep.processmgt.model.CreateFile updateImpl(
		org.oep.processmgt.model.CreateFile createFile)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(createFile);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.processmgt.model.CreateFile findByPrimaryKey(
		long createFileId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.oep.processmgt.NoSuchCreateFileException {
		return getPersistence().findByPrimaryKey(createFileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.processmgt.model.CreateFile fetchByPrimaryKey(
		long createFileId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(createFileId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.processmgt.model.CreateFile> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CreateFilePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CreateFilePersistence)PortletBeanLocatorUtil.locate(org.oep.processmgt.service.ClpSerializer.getServletContextName(),
					CreateFilePersistence.class.getName());

			ReferenceRegistry.registerReference(CreateFileUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CreateFilePersistence persistence) {
	}

	private static CreateFilePersistence _persistence;
}