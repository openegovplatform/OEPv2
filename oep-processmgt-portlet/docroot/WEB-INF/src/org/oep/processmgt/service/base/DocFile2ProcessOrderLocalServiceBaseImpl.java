...
import org.oep.processmgt.service.DocFile2ProcessOrderLocalService;
...
/**
 * Provides the base implementation for the doc file2 process order local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.processmgt.service.impl.DocFile2ProcessOrderLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DocFile2ProcessOrderLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocFile2ProcessOrderLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.processmgt.service.DocFile2ProcessOrderLocalServiceUtil} to access the doc file2 process order local service.
	 */
	...
	public DocFile2ProcessOrder addDocFile2ProcessOrder(
		...
		return docFile2ProcessOrderPersistence.update(docFile2ProcessOrder);
	}
	 ...
	 */
	@Override
	public DocFile2ProcessOrder createDocFile2ProcessOrder(long docFileId) {
		return docFile2ProcessOrderPersistence.create(docFileId);
	}
	...
	@Override
	public DocFile2ProcessOrder deleteDocFile2ProcessOrder(long docFileId)
		throws PortalException, SystemException {
		return docFile2ProcessOrderPersistence.remove(docFileId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocFile2ProcessOrder deleteDocFile2ProcessOrder(
		DocFile2ProcessOrder docFile2ProcessOrder) throws SystemException {
		return docFile2ProcessOrderPersistence.remove(docFile2ProcessOrder);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocFile2ProcessOrder.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return docFile2ProcessOrderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return docFile2ProcessOrderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocFile2ProcessOrder fetchDocFile2ProcessOrder(long docFileId)
		throws SystemException {
		return docFile2ProcessOrderPersistence.fetchByPrimaryKey(docFileId);
	}
	 ...
	 */
	@Override
	public DocFile2ProcessOrder getDocFile2ProcessOrder(long docFileId)
		throws PortalException, SystemException {
		return docFile2ProcessOrderPersistence.findByPrimaryKey(docFileId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return docFile2ProcessOrderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocFile2ProcessOrder> getDocFile2ProcessOrders(int start,
		int end) throws SystemException {
		return docFile2ProcessOrderPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDocFile2ProcessOrdersCount() throws SystemException {
		return docFile2ProcessOrderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocFile2ProcessOrder updateDocFile2ProcessOrder(
		DocFile2ProcessOrder docFile2ProcessOrder) throws SystemException {
		return docFile2ProcessOrderPersistence.update(docFile2ProcessOrder);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.processmgt.model.DocFile2ProcessOrder",
			docFile2ProcessOrderLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = docFile2ProcessOrderPersistence.getDataSource();
	...
	private DocFile2ProcessOrderLocalServiceClpInvoker _clpInvoker = new DocFile2ProcessOrderLocalServiceClpInvoker();
}