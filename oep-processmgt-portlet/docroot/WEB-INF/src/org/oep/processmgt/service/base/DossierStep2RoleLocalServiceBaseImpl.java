...
import org.oep.processmgt.service.DossierStep2RoleLocalService;
...
/**
 * Provides the base implementation for the dossier step2 role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.processmgt.service.impl.DossierStep2RoleLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierStep2RoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierStep2RoleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.processmgt.service.DossierStep2RoleLocalServiceUtil} to access the dossier step2 role local service.
	 */
	...
	public DossierStep2Role addDossierStep2Role(
		DossierStep2Role dossierStep2Role) throws SystemException {
		dossierStep2Role.setNew(true);

		return dossierStep2RolePersistence.update(dossierStep2Role);
	}
	...
	public DossierStep2Role deleteDossierStep2Role(
		DossierStep2Role dossierStep2Role) throws SystemException {
		return dossierStep2RolePersistence.remove(dossierStep2Role);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierStep2Role.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dossierStep2RolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dossierStep2RolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dossierStep2RolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierStep2Role> getDossierStep2Roles(int start, int end)
		throws SystemException {
		return dossierStep2RolePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDossierStep2RolesCount() throws SystemException {
		return dossierStep2RolePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DossierStep2Role updateDossierStep2Role(
		DossierStep2Role dossierStep2Role) throws SystemException {
		return dossierStep2RolePersistence.update(dossierStep2Role);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.processmgt.model.DossierStep2Role",
			dossierStep2RoleLocalService);
	}
	...
	private DossierStep2RoleLocalServiceClpInvoker _clpInvoker = new DossierStep2RoleLocalServiceClpInvoker();
}