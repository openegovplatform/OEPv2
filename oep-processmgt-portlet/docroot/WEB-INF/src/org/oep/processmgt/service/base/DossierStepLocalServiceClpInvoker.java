...
public class DossierStepLocalServiceClpInvoker {
	public DossierStepLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"org.oep.processmgt.model.DossierStep"
			};
		...
		_methodName133 = "updateDossierStep";
		...
		_methodName134 = "updateDossierStepResources";

		_methodParameterTypes134 = new String[] {
				"org.oep.processmgt.model.DossierStep", "java.lang.String[][]",
				"java.lang.String[][]",
				"com.liferay.portal.service.ServiceContext"
			};

		_methodName135 = "removeDossierStep";

		_methodParameterTypes135 = new String[] {
				"org.oep.processmgt.model.DossierStep"
			};

		_methodName136 = "removeDossierStep";

		_methodParameterTypes136 = new String[] { "long" };

		_methodName137 = "getDossierStep";
		...
		_methodParameterTypes138 = new String[] {
				"org.oep.processmgt.model.DossierStep", "boolean", "boolean",
				"com.liferay.portal.service.ServiceContext"
			};

		_methodName139 = "addDossierStepResources";
		...
		_methodName140 = "addDossierStepResources";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DossierStepLocalServiceUtil.addDossierStep((org.oep.processmgt.model.DossierStep)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DossierStepLocalServiceUtil.deleteDossierStep((org.oep.processmgt.model.DossierStep)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return DossierStepLocalServiceUtil.updateDossierStep((org.oep.processmgt.model.DossierStep)arguments[0]);
		}
		...
		if (_methodName134.equals(name) &&
			...
			DossierStepLocalServiceUtil.updateDossierStepResources((org.oep.processmgt.model.DossierStep)arguments[0],
				(java.lang.String[])arguments[1],
				(java.lang.String[])arguments[2],
		...
		if (_methodName135.equals(name) &&
			...
			DossierStepLocalServiceUtil.removeDossierStep((org.oep.processmgt.model.DossierStep)arguments[0]);
		...
		if (_methodName138.equals(name) &&
			...
			DossierStepLocalServiceUtil.addDossierStepResources((org.oep.processmgt.model.DossierStep)arguments[0],
