...
import org.oep.processmgt.service.StepTransitionLocalService;
...
/**
 * Provides the base implementation for the step transition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.processmgt.service.impl.StepTransitionLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class StepTransitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StepTransitionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.processmgt.service.StepTransitionLocalServiceUtil} to access the step transition local service.
	 */
	...
	@Override
	public StepTransition addStepTransition(StepTransition stepTransition)
		throws SystemException {
		stepTransition.setNew(true);

		return stepTransitionPersistence.update(stepTransition);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StepTransition deleteStepTransition(StepTransition stepTransition)
		throws SystemException {
		return stepTransitionPersistence.remove(stepTransition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StepTransition.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return stepTransitionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return stepTransitionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return stepTransitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StepTransition> getStepTransitions(int start, int end)
		throws SystemException {
		return stepTransitionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStepTransitionsCount() throws SystemException {
		return stepTransitionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StepTransition updateStepTransition(StepTransition stepTransition)
		throws SystemException {
		return stepTransitionPersistence.update(stepTransition);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.processmgt.model.StepTransition",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = stepTransitionPersistence.getDataSource();
	...
	private StepTransitionLocalServiceClpInvoker _clpInvoker = new StepTransitionLocalServiceClpInvoker();
}