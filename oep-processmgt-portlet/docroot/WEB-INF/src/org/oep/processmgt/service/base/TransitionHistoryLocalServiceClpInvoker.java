...
public class TransitionHistoryLocalServiceClpInvoker {
	public TransitionHistoryLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"org.oep.processmgt.model.TransitionHistory"
			};
		...
		_methodName114 = "addTransitionHistory";
		...
		_methodName115 = "updateTransitionHistory";
		...
		_methodName116 = "updateTransitionHistoryResources";
		...
		_methodName117 = "removeTransitionHistory";

		_methodParameterTypes117 = new String[] {
				"org.oep.processmgt.model.TransitionHistory"
			};

		_methodName118 = "removeTransitionHistory";

		_methodParameterTypes118 = new String[] { "long" };

		_methodName119 = "getTransitionHistory";
		...
		_methodParameterTypes120 = new String[] {
				"org.oep.processmgt.model.TransitionHistory", "boolean",
				"boolean", "com.liferay.portal.service.ServiceContext"
			};

		_methodName121 = "addTransitionHistoryResources";
		...
		_methodName122 = "addTransitionHistoryResources";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return TransitionHistoryLocalServiceUtil.addTransitionHistory((org.oep.processmgt.model.TransitionHistory)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return TransitionHistoryLocalServiceUtil.deleteTransitionHistory((org.oep.processmgt.model.TransitionHistory)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return TransitionHistoryLocalServiceUtil.updateTransitionHistory((org.oep.processmgt.model.TransitionHistory)arguments[0]);
		}
		...
		if (_methodName116.equals(name) &&
			...
			TransitionHistoryLocalServiceUtil.updateTransitionHistoryResources((org.oep.processmgt.model.TransitionHistory)arguments[0],
		...
		if (_methodName117.equals(name) &&
			...
			TransitionHistoryLocalServiceUtil.removeTransitionHistory((org.oep.processmgt.model.TransitionHistory)arguments[0]);
		...
		if (_methodName120.equals(name) &&
			...
			TransitionHistoryLocalServiceUtil.addTransitionHistoryResources((org.oep.processmgt.model.TransitionHistory)arguments[0],
