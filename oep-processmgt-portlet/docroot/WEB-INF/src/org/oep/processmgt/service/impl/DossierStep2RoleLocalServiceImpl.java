...
import org.oep.processmgt.service.impl.DossierStep2RoleLocalServiceImpl;
import org.oep.processmgt.service.persistence.DossierStep2RolePK;
import org.oep.processmgt.service.base.DossierStep2RoleLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link org.oep.processmgt.service.DossierStep2RoleLocalService} interface.
 *
 * <p>
 ...
 * @see org.oep.processmgt.service.DossierStep2RoleLocalServiceUtil
 */
public class DossierStep2RoleLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link org.oep.processmgt.service.DossierStep2RoleLocalServiceUtil} to access the dossier step2 role local service.
	 */
	...
	public List<DossierStep2Role> getAllByDossierStepId(long dossierStepId) throws PortalException, SystemException {
		return dossierStep2RolePersistence.findByD(dossierStepId);
	}
	
	public List<DossierStep2Role> getAllByRoleId(long roleId) throws PortalException, SystemException {
		return dossierStep2RolePersistence.findByR(roleId);
	}
