...
import org.oep.processmgt.NoSuchDossierStepException;
import org.oep.processmgt.model.DossierStep;
import org.oep.processmgt.model.impl.DossierStepImpl;
import org.oep.processmgt.model.impl.DossierStepModelImpl;
...
public class DossierStepPersistenceImpl extends BasePersistenceImpl<DossierStep>
	...
	protected DossierStep toUnwrappedModel(DossierStep dossierStep) {
		...
		dossierStepImpl.setDaysDuration(dossierStep.getDaysDuration());
		dossierStepImpl.setDoForm(dossierStep.getDoForm());
		dossierStepImpl.setFormLabel(dossierStep.getFormLabel());
		dossierStepImpl.setRollback(dossierStep.getRollback());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.processmgt.model.DossierStep")));
