...
public class AppMessageWrapper implements AppMessage, ModelWrapper<AppMessage> {
	...
	*/
	...
	@Override
	public int compareTo(org.oep.ssomgt.model.AppMessage appMessage) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.ssomgt.model.AppMessage> toCacheModel() {
		return _appMessage.toCacheModel();
	}

	@Override
	public org.oep.ssomgt.model.AppMessage toEscapedModel() {
		return new AppMessageWrapper(_appMessage.toEscapedModel());
	}

	@Override
	public org.oep.ssomgt.model.AppMessage toUnescapedModel() {
