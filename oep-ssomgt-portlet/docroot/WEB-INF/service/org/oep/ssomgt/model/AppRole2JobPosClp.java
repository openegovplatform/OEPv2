...
public class AppRole2JobPosClp extends BaseModelImpl<AppRole2JobPos>
	...
	public void setJobPosId(long jobPosId) {
		...
		if (_appRole2JobPosRemoteModel != null) {
			try {
				...
				method.invoke(_appRole2JobPosRemoteModel, jobPosId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public org.oep.usermgt.model.WorkingUnit getWorkingUnit() {
		try {
			String methodName = "getWorkingUnit";

			Class<?>[] parameterTypes = new Class<?>[] {  };

			Object[] parameterValues = new Object[] {  };

			org.oep.usermgt.model.WorkingUnit returnObj = (org.oep.usermgt.model.WorkingUnit)invokeOnRemoteModel(methodName,
	...
	public org.oep.usermgt.model.JobPos getJobPos() {
		try {
			String methodName = "getJobPos";

			Class<?>[] parameterTypes = new Class<?>[] {  };

			Object[] parameterValues = new Object[] {  };

			org.oep.usermgt.model.JobPos returnObj = (org.oep.usermgt.model.JobPos)invokeOnRemoteModel(methodName,
					parameterTypes, parameterValues);
	...
	public String toXmlString() {
		...
		sb.append("org.oep.ssomgt.model.AppRole2JobPos");
