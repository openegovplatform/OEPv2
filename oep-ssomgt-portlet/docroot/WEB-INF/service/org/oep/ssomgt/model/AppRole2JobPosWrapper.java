...
public class AppRole2JobPosWrapper implements AppRole2JobPos,
	...
	*/
	...
	/**
	* Returns the job pos ID of this app role2 job pos.
	*
	* @return the job pos ID of this app role2 job pos
	*/
	@Override
	public long getJobPosId() {
		return _appRole2JobPos.getJobPosId();
	}

	/**
	* Sets the job pos ID of this app role2 job pos.
	*
	* @param jobPosId the job pos ID of this app role2 job pos
	*/
	@Override
	public void setJobPosId(long jobPosId) {
		_appRole2JobPos.setJobPosId(jobPosId);
	}
	...
	@Override
	public int compareTo(org.oep.ssomgt.model.AppRole2JobPos appRole2JobPos) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<org.oep.ssomgt.model.AppRole2JobPos> toCacheModel() {
		return _appRole2JobPos.toCacheModel();
	}

	@Override
	public org.oep.ssomgt.model.AppRole2JobPos toEscapedModel() {
		return new AppRole2JobPosWrapper(_appRole2JobPos.toEscapedModel());
	}

	@Override
	public org.oep.ssomgt.model.AppRole2JobPos toUnescapedModel() {
	...
	@Override
	public org.oep.usermgt.model.JobPos getJobPos() {
		return _appRole2JobPos.getJobPos();
	}

	@Override
	public org.oep.usermgt.model.WorkingUnit getWorkingUnit() {
		return _appRole2JobPos.getWorkingUnit();
	}
