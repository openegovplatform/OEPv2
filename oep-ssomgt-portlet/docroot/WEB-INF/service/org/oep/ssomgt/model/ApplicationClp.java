...
public class ApplicationClp extends BaseModelImpl<Application>
	...
	public void setPublicKey(String publicKey) {
		...
		if (_applicationRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setPublicKey", String.class);

				method.invoke(_applicationRemoteModel, publicKey);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setPublicKey(getPublicKey());
	...
	public String toXmlString() {
		...
		sb.append("org.oep.ssomgt.model.Application");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>publicKey</column-name><column-value><![CDATA[");
		sb.append(getPublicKey());
		sb.append("]]></column-value></column>");
