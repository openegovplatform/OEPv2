...
/**
 * Provides the local service interface for AppRole2Employee. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see AppRole2EmployeeLocalServiceUtil
...
public interface AppRole2EmployeeLocalService extends BaseLocalService,
	...
	*/
	...
	/**
	* ThÃªm má»›i má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng theo cÃ¡n bá»™
	*
	* Version: OEP 2.0
	*
	* History:
	...
	* @param employeeId mÃ£ cÃ¡n bá»™ viÃªn chá»©c
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p cho cÃ¡n bá»™ má»›i Ä‘Æ°á»£c thÃªm vÃ o
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.ssomgt.model.AppRole2Employee addAppRole2Employee(
	...
	* @param employeeId mÃ£ cÃ¡n bá»™ viÃªn chá»©c
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p theo cÃ¡n bá»™ má»›i Ä‘Æ°á»£c cáº­p nháº­t
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.ssomgt.model.AppRole2Employee updateAppRole2Employee(
	...
	/**
	* Cáº­p nháº­t thÃ´ng tin má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param appRole2Employee vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™ cáº§n cáº­p nháº­t thÃ´ng tin
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™ má»›i Ä‘Æ°á»£c cáº­p nháº­t thÃ´ng tin
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.ssomgt.model.AppRole2Employee updateAppRole2Employee(
		org.oep.ssomgt.model.AppRole2Employee appRole2Employee,
	...
	/**
	* XÃ³a bá»� thÃ´ng tin má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™ Ä‘Æ°á»£c tÃ­ch há»£p trong cá»•ng
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param appRole2Employee vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™ sáº½ bá»‹ xÃ³a
	* @return
	*/
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param id mÃ£ phÃ¢n biá»‡t vai trÃ² truy cáº­p á»©ng dá»¥ng cho cÃ¡n bá»™
	* @return
	*/
