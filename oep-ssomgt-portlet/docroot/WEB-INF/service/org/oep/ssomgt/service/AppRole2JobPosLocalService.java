...
/**
 * Provides the local service interface for AppRole2JobPos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see AppRole2JobPosLocalServiceUtil
...
public interface AppRole2JobPosLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AppRole2JobPosLocalServiceUtil} to access the app role2 job pos local service. Add custom service methods to {@link org.oep.ssomgt.service.impl.AppRole2JobPosLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	/**
	* ThÃªm má»›i má»™t vai trÃ² truy cáº­p cho vá»‹ trÃ­ cÃ´ng tÃ¡c
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*
	* @param appRoleId mÃ£ vai trÃ² á»©ng dá»¥ng
	* @param jobPosId mÃ£ vá»‹ trÃ­ cÃ´ng tÃ¡c
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p vá»‹ trÃ­ cÃ´ng tÃ¡c má»›i Ä‘Æ°á»£c thÃªm vÃ o
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.ssomgt.model.AppRole2JobPos addAppRole2JobPos(
	...
	/**
	* Cáº­p nháº­t thÃ´ng tin má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param id mÃ£ phÃ¢n biá»‡t vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c
	* @param appRoleId mÃ£ vai trÃ² á»©ng dá»¥ng
	* @param jobPosId mÃ£ vá»‹ trÃ­ cÃ´ng tÃ¡c
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c má»›i Ä‘Æ°á»£c cáº­p nháº­t
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param appRole2JobPos vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c cáº§n cáº­p nháº­t thÃ´ng tin
	* @param serviceContext ngá»¯ cáº£nh dá»‹ch vá»¥
	* @return: Ä‘á»‘i tÆ°á»£ng vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c má»›i Ä‘Æ°á»£c cáº­p nháº­t thÃ´ng tin
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public org.oep.ssomgt.model.AppRole2JobPos updateAppRole2JobPos(
		org.oep.ssomgt.model.AppRole2JobPos appRole2JobPos,
	...
	/**
	* XÃ³a bá»� thÃ´ng tin má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c Ä‘Æ°á»£c tÃ­ch há»£p trong cá»•ng
	*
	* Version: OEP 2.0
	*
	* History:
	...
	*  21-September-2015  trungdk    Táº¡o má»›i
	*
	* @param appRole2JobPos vai trÃ² truy cáº­p á»©ng dá»¥ng theo vá»‹ trÃ­ cÃ´ng tÃ¡c sáº½ bá»‹ xÃ³a
	* @return
	*/
	...
	/**
	* XÃ³a bá»� thÃ´ng tin má»™t vai trÃ² truy cáº­p á»©ng dá»¥ng Ä‘Æ°á»£c tÃ­ch há»£p trong cá»•ng
	*
	* Version: OEP 2.0
	*
	* History:
