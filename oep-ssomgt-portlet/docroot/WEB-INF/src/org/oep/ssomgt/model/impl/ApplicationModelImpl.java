...
import org.oep.ssomgt.model.ApplicationAppBigIconBlobModel;
import org.oep.ssomgt.model.ApplicationAppSmallIconBlobModel;
import org.oep.ssomgt.model.ApplicationModel;
import org.oep.ssomgt.model.ApplicationSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link org.oep.ssomgt.model.ApplicationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ApplicationImpl}.
 * </p>
 *
 * @author trungdk
 * @see ApplicationImpl
 * @see org.oep.ssomgt.model.Application
 * @see org.oep.ssomgt.model.ApplicationModel
 * @generated
 */
@JSON(strict = true)
public class ApplicationModelImpl extends BaseModelImpl<Application>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a application model instance should use the {@link org.oep.ssomgt.model.Application} interface instead.
	 */
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "publicKey", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table oep_ssomgt_application (applicationId LONG not null primary key,userId LONG,groupId LONG,companyId LONG,createDate DATE null,modifiedDate DATE null,appCode VARCHAR(30) null,appName VARCHAR(100) null,appPin VARCHAR(30) null,appUrl VARCHAR(100) null,appBigIcon BLOB,appSmallIcon BLOB,pingTime DATE null,sequenceNo INTEGER,publicKey VARCHAR(256) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.org.oep.ssomgt.model.Application"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.org.oep.ssomgt.model.Application"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.oep.ssomgt.model.Application"),
			true);
	...
	public static Application toModel(ApplicationSoap soapModel) {
		...
		model.setPublicKey(soapModel.getPublicKey());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.org.oep.ssomgt.model.Application"));
	...
	public Object clone() {
		...
		applicationImpl.setPublicKey(getPublicKey());
	...
	public CacheModel<Application> toCacheModel() {
		...
		applicationCacheModel.publicKey = getPublicKey();

		String publicKey = applicationCacheModel.publicKey;

		if ((publicKey != null) && (publicKey.length() == 0)) {
			applicationCacheModel.publicKey = null;
		}
