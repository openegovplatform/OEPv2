...
import org.oep.ssomgt.service.ApplicationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.ssomgt.service.impl.ApplicationLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
...
public abstract class ApplicationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.ssomgt.service.ApplicationLocalServiceUtil} to access the application local service.
	 */
	...
	public ApplicationAppSmallIconBlobModel getAppSmallIconBlobModel(
		...
		try {
			...
			return (org.oep.ssomgt.model.ApplicationAppSmallIconBlobModel)session.get(ApplicationAppSmallIconBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw applicationPersistence.processException(e);
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.ssomgt.model.Application",
