...
import org.oep.ssomgt.service.base.AppRoleLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link org.oep.ssomgt.service.AppRoleLocalService} interface.
 *
 * <p>
 ...
 * @see org.oep.ssomgt.service.AppRoleLocalServiceUtil
 */
public class AppRoleLocalServiceImpl extends AppRoleLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link org.oep.ssomgt.service.AppRoleLocalServiceUtil} to access the app role local service.
	 */
	...
	public void validate(long appRoleId, String roleCode, String roleName) throws DuplicateRoleCodeException, RoleCodeRangeLengthException, RoleNameRangeLengthException {
		if (appRoleId == 0) {
			AppRole appRole = null;
			try {
				appRole = appRolePersistence.fetchByRC(roleCode);
			...
			if (appRole != null && appRole.getAppRoleId() != appRoleId) {
				throw new DuplicateRoleCodeException();
			}
			
		}
		if (StringUtil.isNullOrEmpty(roleCode) || roleCode.length() > MAX_ROLE_CODE_LENGTH) {
			throw new RoleCodeRangeLengthException();
		}
		if (StringUtil.isNullOrEmpty(roleName) || (roleName.length() > MAX_ROLE_NAME_LENGTH))
			throw new RoleNameRangeLengthException();
	}
	
	private static final int MAX_ROLE_CODE_LENGTH = 30;
