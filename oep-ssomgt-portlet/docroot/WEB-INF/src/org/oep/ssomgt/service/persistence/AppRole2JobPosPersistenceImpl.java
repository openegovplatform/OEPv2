...
import org.oep.ssomgt.NoSuchAppRole2JobPosException;
import org.oep.ssomgt.model.AppRole2JobPos;
import org.oep.ssomgt.model.impl.AppRole2JobPosImpl;
import org.oep.ssomgt.model.impl.AppRole2JobPosModelImpl;
...
public class AppRole2JobPosPersistenceImpl extends BasePersistenceImpl<AppRole2JobPos>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED,
			AppRole2JobPosImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_InJobPos",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED,
			AppRole2JobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_InJobPos",
			new String[] { Long.class.getName(), Long.class.getName() },
			AppRole2JobPosModelImpl.COMPANYID_COLUMN_BITMASK |
			AppRole2JobPosModelImpl.JOBPOSID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_INJOBPOS = new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_InJobPos",
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_InJobPos",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<AppRole2JobPos> findByC_InJobPos(long companyId, long jobPosId)
		throws SystemException {
		return findByC_InJobPos(companyId, jobPosId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<AppRole2JobPos> findByC_InJobPos(long companyId, long jobPosId,
		int start, int end) throws SystemException {
		return findByC_InJobPos(companyId, jobPosId, start, end, null);
	}
	...
	public List<AppRole2JobPos> findByC_InJobPos(long companyId, long jobPosId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_INJOBPOS;
			finderArgs = new Object[] { companyId, jobPosId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_INJOBPOS;
			finderArgs = new Object[] {
					companyId, jobPosId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (AppRole2JobPos appRole2JobPos : list) {
				if ((companyId != appRole2JobPos.getCompanyId()) ||
						(jobPosId != appRole2JobPos.getJobPosId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_INJOBPOS_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_INJOBPOS_JOBPOSID_2);
	 ...
	 */
	@Override
	public AppRole2JobPos findByC_InJobPos_First(long companyId, long jobPosId,
		OrderByComparator orderByComparator)
		throws NoSuchAppRole2JobPosException, SystemException {
		AppRole2JobPos appRole2JobPos = fetchByC_InJobPos_First(companyId,
				jobPosId, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos fetchByC_InJobPos_First(long companyId,
		long jobPosId, OrderByComparator orderByComparator)
		throws SystemException {
		List<AppRole2JobPos> list = findByC_InJobPos(companyId, jobPosId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos findByC_InJobPos_Last(long companyId, long jobPosId,
		OrderByComparator orderByComparator)
		throws NoSuchAppRole2JobPosException, SystemException {
		AppRole2JobPos appRole2JobPos = fetchByC_InJobPos_Last(companyId,
				jobPosId, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos fetchByC_InJobPos_Last(long companyId, long jobPosId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByC_InJobPos(companyId, jobPosId);

		if (count == 0) {
			return null;
		}

		List<AppRole2JobPos> list = findByC_InJobPos(companyId, jobPosId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos[] findByC_InJobPos_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_InJobPos_PrevAndNext(session, appRole2JobPos,
					companyId, jobPosId, orderByComparator, true);

			array[1] = appRole2JobPos;

			array[2] = getByC_InJobPos_PrevAndNext(session, appRole2JobPos,
					companyId, jobPosId, orderByComparator, false);
	...
	protected AppRole2JobPos getByC_InJobPos_PrevAndNext(Session session,
		AppRole2JobPos appRole2JobPos, long companyId, long jobPosId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<AppRole2JobPos> findByC_InJobPos(long companyId,
		long[] jobPosIds) throws SystemException {
		return findByC_InJobPos(companyId, jobPosIds, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<AppRole2JobPos> findByC_InJobPos(long companyId,
		long[] jobPosIds, int start, int end) throws SystemException {
		return findByC_InJobPos(companyId, jobPosIds, start, end, null);
	}
	...
	public List<AppRole2JobPos> findByC_InJobPos(long companyId,
		...
		if ((jobPosIds != null) && (jobPosIds.length == 1)) {
			return findByC_InJobPos(companyId, jobPosIds[0], start, end,
				orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderArgs = new Object[] { companyId, StringUtil.merge(jobPosIds) };
		}
		else {
			finderArgs = new Object[] {
					companyId, StringUtil.merge(jobPosIds),
					
					start, end, orderByComparator
				};
		}

		List<AppRole2JobPos> list = (List<AppRole2JobPos>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_INJOBPOS,
				finderArgs, this);

		if ((list != null) && !list.isEmpty()) {
			for (AppRole2JobPos appRole2JobPos : list) {
				if ((companyId != appRole2JobPos.getCompanyId()) ||
						!ArrayUtil.contains(jobPosIds,
							appRole2JobPos.getJobPosId())) {
					list = null;
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_INJOBPOS,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_INJOBPOS,
					finderArgs);
	...
	public void removeByC_InJobPos(long companyId, long jobPosId)
		throws SystemException {
		for (AppRole2JobPos appRole2JobPos : findByC_InJobPos(companyId,
				jobPosId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(appRole2JobPos);
		}
	}
	...
	public int countByC_InJobPos(long companyId, long jobPosId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_INJOBPOS;

		Object[] finderArgs = new Object[] { companyId, jobPosId };
	...
	public int countByC_InJobPos(long companyId, long[] jobPosIds)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_INJOBPOS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_INJOBPOS,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_INJOBPOS,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_C_INJOBPOS_COMPANYID_2 = "appRole2JobPos.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_INJOBPOS_COMPANYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_INJOBPOS_COMPANYID_2) + ")";
	private static final String _FINDER_COLUMN_C_INJOBPOS_JOBPOSID_2 = "appRole2JobPos.jobPosId = ?";
	private static final String _FINDER_COLUMN_C_INJOBPOS_JOBPOSID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_INJOBPOS_JOBPOSID_2) + ")";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED,
			AppRole2JobPosImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_G_InJobPos",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED,
			AppRole2JobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_G_InJobPos",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			AppRole2JobPosModelImpl.COMPANYID_COLUMN_BITMASK |
			AppRole2JobPosModelImpl.GROUPID_COLUMN_BITMASK |
			AppRole2JobPosModelImpl.JOBPOSID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_INJOBPOS = new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_G_InJobPos",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_INJOBPOS =
		new FinderPath(AppRole2JobPosModelImpl.ENTITY_CACHE_ENABLED,
			AppRole2JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_G_InJobPos",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
	 ...
	 */
	@Override
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		long groupId, long jobPosId) throws SystemException {
		return findByC_G_InJobPos(companyId, groupId, jobPosId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		long groupId, long jobPosId, int start, int end)
		throws SystemException {
		return findByC_G_InJobPos(companyId, groupId, jobPosId, start, end, null);
	}
	...
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_INJOBPOS;
			finderArgs = new Object[] { companyId, groupId, jobPosId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_INJOBPOS;
			finderArgs = new Object[] {
					companyId, groupId, jobPosId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_G_INJOBPOS_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_G_INJOBPOS_GROUPID_2);

			query.append(_FINDER_COLUMN_C_G_INJOBPOS_JOBPOSID_2);
	 ...
	 */
	@Override
	public AppRole2JobPos findByC_G_InJobPos_First(long companyId,
		long groupId, long jobPosId, OrderByComparator orderByComparator)
		throws NoSuchAppRole2JobPosException, SystemException {
		AppRole2JobPos appRole2JobPos = fetchByC_G_InJobPos_First(companyId,
				groupId, jobPosId, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos fetchByC_G_InJobPos_First(long companyId,
		long groupId, long jobPosId, OrderByComparator orderByComparator)
		throws SystemException {
		List<AppRole2JobPos> list = findByC_G_InJobPos(companyId, groupId,
				jobPosId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos findByC_G_InJobPos_Last(long companyId, long groupId,
		long jobPosId, OrderByComparator orderByComparator)
		throws NoSuchAppRole2JobPosException, SystemException {
		AppRole2JobPos appRole2JobPos = fetchByC_G_InJobPos_Last(companyId,
				groupId, jobPosId, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos fetchByC_G_InJobPos_Last(long companyId,
		long groupId, long jobPosId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByC_G_InJobPos(companyId, groupId, jobPosId);
		...
		List<AppRole2JobPos> list = findByC_G_InJobPos(companyId, groupId,
				jobPosId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public AppRole2JobPos[] findByC_G_InJobPos_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_G_InJobPos_PrevAndNext(session, appRole2JobPos,
					companyId, groupId, jobPosId, orderByComparator, true);

			array[1] = appRole2JobPos;

			array[2] = getByC_G_InJobPos_PrevAndNext(session, appRole2JobPos,
					companyId, groupId, jobPosId, orderByComparator, false);
	...
	protected AppRole2JobPos getByC_G_InJobPos_PrevAndNext(Session session,
		AppRole2JobPos appRole2JobPos, long companyId, long groupId,
		long jobPosId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	@Override
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		long groupId, long[] jobPosIds) throws SystemException {
		return findByC_G_InJobPos(companyId, groupId, jobPosIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		long groupId, long[] jobPosIds, int start, int end)
		throws SystemException {
		return findByC_G_InJobPos(companyId, groupId, jobPosIds, start, end,
			null);
	}
	...
	public List<AppRole2JobPos> findByC_G_InJobPos(long companyId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if ((jobPosIds != null) && (jobPosIds.length == 1)) {
			return findByC_G_InJobPos(companyId, groupId, jobPosIds[0], start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderArgs = new Object[] {
					companyId, groupId, StringUtil.merge(jobPosIds)
				};
		}
		else {
			finderArgs = new Object[] {
		...
		List<AppRole2JobPos> list = (List<AppRole2JobPos>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_INJOBPOS,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_INJOBPOS,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_INJOBPOS,
					finderArgs);
	...
	public void removeByC_G_InJobPos(long companyId, long groupId, long jobPosId)
		throws SystemException {
		for (AppRole2JobPos appRole2JobPos : findByC_G_InJobPos(companyId,
				groupId, jobPosId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(appRole2JobPos);
		}
	}
	...
	public int countByC_G_InJobPos(long companyId, long groupId, long jobPosId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_G_INJOBPOS;

		Object[] finderArgs = new Object[] { companyId, groupId, jobPosId };
	...
	public int countByC_G_InJobPos(long companyId, long groupId,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_INJOBPOS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_INJOBPOS,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_INJOBPOS,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_COMPANYID_2 = "appRole2JobPos.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_COMPANYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_G_INJOBPOS_COMPANYID_2) + ")";
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_GROUPID_2 = "appRole2JobPos.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_GROUPID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_G_INJOBPOS_GROUPID_2) + ")";
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_JOBPOSID_2 = "appRole2JobPos.jobPosId = ?";
	private static final String _FINDER_COLUMN_C_G_INJOBPOS_JOBPOSID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_G_INJOBPOS_JOBPOSID_2) + ")";
	...
	public AppRole2JobPos updateImpl(
		...
		if (isNew || !AppRole2JobPosModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((appRole2JobPosModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_INJOBPOS.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						appRole2JobPosModelImpl.getOriginalCompanyId(),
						appRole2JobPosModelImpl.getOriginalJobPosId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_INJOBPOS,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_INJOBPOS,
					args);

				args = new Object[] {
						appRole2JobPosModelImpl.getCompanyId(),
						appRole2JobPosModelImpl.getJobPosId()
					};
			...
			if ((appRole2JobPosModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_INJOBPOS.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						appRole2JobPosModelImpl.getOriginalCompanyId(),
						appRole2JobPosModelImpl.getOriginalGroupId(),
						appRole2JobPosModelImpl.getOriginalJobPosId()
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_G_INJOBPOS,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_INJOBPOS,
					args);
	...
	protected AppRole2JobPos toUnwrappedModel(AppRole2JobPos appRole2JobPos) {
		...
		appRole2JobPosImpl.setJobPosId(appRole2JobPos.getJobPosId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.ssomgt.model.AppRole2JobPos")));
