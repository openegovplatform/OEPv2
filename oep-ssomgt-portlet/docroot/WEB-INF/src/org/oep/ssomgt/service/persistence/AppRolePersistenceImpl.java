...
import org.oep.ssomgt.NoSuchAppRoleException;
import org.oep.ssomgt.model.AppRole;
import org.oep.ssomgt.model.impl.AppRoleImpl;
import org.oep.ssomgt.model.impl.AppRoleModelImpl;
...
public class AppRolePersistenceImpl extends BasePersistenceImpl<AppRole>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_RC = new FinderPath(AppRoleModelImpl.ENTITY_CACHE_ENABLED,
			AppRoleModelImpl.FINDER_CACHE_ENABLED, AppRoleImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByRC",
			new String[] { String.class.getName() },
			AppRoleModelImpl.ROLECODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_RC = new FinderPath(AppRoleModelImpl.ENTITY_CACHE_ENABLED,
			AppRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByRC",
			new String[] { String.class.getName() });
	 ...
	 */
	@Override
	public AppRole findByRC(String roleCode)
		throws NoSuchAppRoleException, SystemException {
		AppRole appRole = fetchByRC(roleCode);
	 ...
	 */
	@Override
	public AppRole fetchByRC(String roleCode) throws SystemException {
		return fetchByRC(roleCode, true);
	}
	 ...
	 */
	@Override
	public AppRole fetchByRC(String roleCode, boolean retrieveFromCache)
		throws SystemException {
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_RC,
					finderArgs, this);
		}

		if (result instanceof AppRole) {
			AppRole appRole = (AppRole)result;

			if (!Validator.equals(roleCode, appRole.getRoleCode())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			if (roleCode == null) {
				query.append(_FINDER_COLUMN_RC_ROLECODE_1);
			}
			else if (roleCode.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_RC_ROLECODE_3);
			}
			else {
				bindRoleCode = true;

				query.append(_FINDER_COLUMN_RC_ROLECODE_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_RC,
						finderArgs, list);
				}
				else {
					AppRole appRole = list.get(0);

					result = appRole;

					cacheResult(appRole);

					if ((appRole.getRoleCode() == null) ||
							!appRole.getRoleCode().equals(roleCode)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_RC,
							finderArgs, appRole);
					}
				}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_RC, finderArgs);
	 ...
	 */
	@Override
	public AppRole removeByRC(String roleCode)
		throws NoSuchAppRoleException, SystemException {
		AppRole appRole = findByRC(roleCode);
	 ...
	 */
	@Override
	public int countByRC(String roleCode) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_RC;
	...
	private static final String _FINDER_COLUMN_RC_ROLECODE_1 = "appRole.roleCode IS NULL";
	private static final String _FINDER_COLUMN_RC_ROLECODE_2 = "appRole.roleCode = ?";
	private static final String _FINDER_COLUMN_RC_ROLECODE_3 = "(appRole.roleCode IS NULL OR appRole.roleCode = '')";
	...
	public void cacheResult(AppRole appRole) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_RC,
			new Object[] { appRole.getRoleCode() }, appRole);
	...
	public void clearCache(AppRole appRole) {
		...
		clearUniqueFindersCache(appRole);
	}
	...
	protected void cacheUniqueFindersCache(AppRole appRole) {
		if (appRole.isNew()) {
			Object[] args = new Object[] { appRole.getRoleCode() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_RC, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_RC, args, appRole);
		}
		else {
			AppRoleModelImpl appRoleModelImpl = (AppRoleModelImpl)appRole;

			if ((appRoleModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_RC.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { appRole.getRoleCode() };
	...
	protected void clearUniqueFindersCache(AppRole appRole) {
		AppRoleModelImpl appRoleModelImpl = (AppRoleModelImpl)appRole;

		Object[] args = new Object[] { appRole.getRoleCode() };

		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_RC, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_RC, args);

		if ((appRoleModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_RC.getColumnBitmask()) != 0) {
			args = new Object[] { appRoleModelImpl.getOriginalRoleCode() };
	...
	@Override
	public AppRole updateImpl(org.oep.ssomgt.model.AppRole appRole)
		throws SystemException {
		appRole = toUnwrappedModel(appRole);
		...
		clearUniqueFindersCache(appRole);
		cacheUniqueFindersCache(appRole);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.ssomgt.model.AppRole")));
