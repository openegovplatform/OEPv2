...
import org.oep.ssomgt.model.impl.ApplicationModelImpl;
...
public class ApplicationPersistenceImpl extends BasePersistenceImpl<Application>
	...
	@Override
	public Application updateImpl(org.oep.ssomgt.model.Application application)
		throws SystemException {
		application = toUnwrappedModel(application);
	...
	protected Application toUnwrappedModel(Application application) {
		...
		applicationImpl.setPublicKey(application.getPublicKey());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.oep.ssomgt.model.Application")));
