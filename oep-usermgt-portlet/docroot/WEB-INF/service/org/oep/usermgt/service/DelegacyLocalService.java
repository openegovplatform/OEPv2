...
/**
 * Provides the local service interface for Delegacy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NQMINH
 * @see DelegacyLocalServiceUtil
...
public interface DelegacyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DelegacyLocalServiceUtil} to access the delegacy local service. Add custom service methods to {@link org.oep.usermgt.service.impl.DelegacyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
