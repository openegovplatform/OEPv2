...
/**
 * Provides the local service interface for SubAccount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NQMINH
 * @see SubAccountLocalServiceUtil
...
public interface SubAccountLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubAccountLocalServiceUtil} to access the sub account local service. Add custom service methods to {@link org.oep.usermgt.service.impl.SubAccountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
