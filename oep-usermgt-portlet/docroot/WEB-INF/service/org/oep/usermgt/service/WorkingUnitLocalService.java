...
public interface WorkingUnitLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkingUnitLocalServiceUtil} to access the Working Unit local service. Add custom service methods to {@link org.oep.usermgt.service.impl.WorkingUnitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*  -------------------------------------------------
	*  21-September-2015  nqminh    Táº¡o má»›i
	*
	* @param userId:
	* @param groupId:
	* @param companyId:
	* @param createDate:NgÃ y táº¡o
	* @param modifiedDate:Ngay sá»­a
	* @param organizationId:Tá»• chá»©c trong cá»•ng
	* @param govAgencyId:CÆ¡ quan Ä‘á»‹nh danh
	* @param name:TÃªn cÆ¡ Ä‘Æ¡n vá»‹
	* @param enName:TÃªn Ä‘Æ¡n vá»‹ tiáº¿ng anh
	* @param parentWorkingUnitId:Ä�Æ¡n vá»‹ cáº¥p trÃªn
	* @param address:Ä�á»‹a chá»‰
	* @param cityNo:
	* @param cityName:Tá»‰nh/ThÃ nh phá»‘
	* @param districtNo:
	* @param districtName:Quáº­n/Huyá»‡n
	* @param wardNo:
	* @param wardName:XÃ£/PhÆ°á»�ng
	* @param gpsPosition:Tá»�a Ä‘á»™
	* @param telNo:Ä�iá»‡n thoáº¡i
	* @param fax:Fax
	* @param email:Email
