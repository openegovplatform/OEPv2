...
public class DossierModelImpl extends BaseModelImpl<Dossier>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "actorType", Types.INTEGER },
			{ "actorNo", Types.VARCHAR },
	...
	public static Dossier toModel(DossierSoap soapModel) {
		...
		model.setActorType(soapModel.getActorType());
		model.setActorNo(soapModel.getActorNo());
		...
		model.setPaymentConfirmed(soapModel.getPaymentConfirmed());
	...
	public Object clone() {
		...
		dossierImpl.setGovAgentNo(getGovAgentNo());
		dossierImpl.setGovAgentName(getGovAgentName());
		dossierImpl.setSubmitterName(getSubmitterName());
		dossierImpl.setActorType(getActorType());
		dossierImpl.setActorNo(getActorNo());
		dossierImpl.setActorName(getActorName());
		...
		dossierImpl.setDescription(getDescription());
		...
		dossierImpl.setStatusName(getStatusName());
		dossierImpl.setFeedbackNote(getFeedbackNote());
		dossierImpl.setPaymentConfirmed(getPaymentConfirmed());
	...
	public CacheModel<Dossier> toCacheModel() {
		...
		dossierCacheModel.govAgentNo = getGovAgentNo();

		String govAgentNo = dossierCacheModel.govAgentNo;

		if ((govAgentNo != null) && (govAgentNo.length() == 0)) {
			dossierCacheModel.govAgentNo = null;
		}
		...
		dossierCacheModel.submitterName = getSubmitterName();

		String submitterName = dossierCacheModel.submitterName;

		if ((submitterName != null) && (submitterName.length() == 0)) {
			dossierCacheModel.submitterName = null;
		}

		dossierCacheModel.actorType = getActorType();

		dossierCacheModel.actorNo = getActorNo();

		String actorNo = dossierCacheModel.actorNo;

		if ((actorNo != null) && (actorNo.length() == 0)) {
			dossierCacheModel.actorNo = null;
		}

		dossierCacheModel.actorName = getActorName();

		String actorName = dossierCacheModel.actorName;

		if ((actorName != null) && (actorName.length() == 0)) {
			dossierCacheModel.actorName = null;
		}
		...
		dossierCacheModel.description = getDescription();

		String description = dossierCacheModel.description;

		if ((description != null) && (description.length() == 0)) {
			dossierCacheModel.description = null;
		}
		...
		dossierCacheModel.statusName = getStatusName();

		String statusName = dossierCacheModel.statusName;

		if ((statusName != null) && (statusName.length() == 0)) {
			dossierCacheModel.statusName = null;
		}
		...
		dossierCacheModel.paymentConfirmed = getPaymentConfirmed();
