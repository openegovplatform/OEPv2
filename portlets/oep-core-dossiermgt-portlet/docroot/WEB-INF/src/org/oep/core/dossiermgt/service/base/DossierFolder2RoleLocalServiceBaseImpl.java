...
import org.oep.core.dossiermgt.service.DossierFolder2RoleLocalService;
...
/**
 * Provides the base implementation for the dossier folder2 role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.dossiermgt.service.impl.DossierFolder2RoleLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierFolder2RoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierFolder2RoleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.dossiermgt.service.DossierFolder2RoleLocalServiceUtil} to access the dossier folder2 role local service.
	 */
	...
	public DossierFolder2Role addDossierFolder2Role(
		...
		return dossierFolder2RolePersistence.update(dossierFolder2Role);
	}
	 ...
	 */
	@Override
	public DossierFolder2Role createDossierFolder2Role(long id) {
		return dossierFolder2RolePersistence.create(id);
	}
	...
	@Override
	public DossierFolder2Role deleteDossierFolder2Role(long id)
		throws PortalException, SystemException {
		return dossierFolder2RolePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DossierFolder2Role deleteDossierFolder2Role(
		DossierFolder2Role dossierFolder2Role) throws SystemException {
		return dossierFolder2RolePersistence.remove(dossierFolder2Role);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierFolder2Role.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dossierFolder2RolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DossierFolder2Role fetchDossierFolder2Role(long id)
		throws SystemException {
		return dossierFolder2RolePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DossierFolder2Role getDossierFolder2Role(long id)
		throws PortalException, SystemException {
		return dossierFolder2RolePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dossierFolder2RolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierFolder2Role> getDossierFolder2Roles(int start, int end)
		throws SystemException {
		return dossierFolder2RolePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDossierFolder2RolesCount() throws SystemException {
		return dossierFolder2RolePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DossierFolder2Role updateDossierFolder2Role(
		DossierFolder2Role dossierFolder2Role) throws SystemException {
		return dossierFolder2RolePersistence.update(dossierFolder2Role);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.dossiermgt.model.DossierFolder2Role",
			dossierFolder2RoleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dossierFolder2RolePersistence.getDataSource();
	...
	private DossierFolder2RoleLocalServiceClpInvoker _clpInvoker = new DossierFolder2RoleLocalServiceClpInvoker();
}