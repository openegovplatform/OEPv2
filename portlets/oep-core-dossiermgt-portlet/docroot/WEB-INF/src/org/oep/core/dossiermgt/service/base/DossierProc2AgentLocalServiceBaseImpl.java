...
import org.oep.core.dossiermgt.service.DossierProc2AgentLocalService;
...
/**
 * Provides the base implementation for the dossier proc2 agent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.dossiermgt.service.impl.DossierProc2AgentLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierProc2AgentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierProc2AgentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.dossiermgt.service.DossierProc2AgentLocalServiceUtil} to access the dossier proc2 agent local service.
	 */
	...
	@Override
	public DossierProc2Agent addDossierProc2Agent(
		DossierProc2Agent dossierProc2Agent) throws SystemException {
		dossierProc2Agent.setNew(true);

		return dossierProc2AgentPersistence.update(dossierProc2Agent);
	}
	 ...
	 */
	@Override
	public DossierProc2Agent createDossierProc2Agent(long id) {
		return dossierProc2AgentPersistence.create(id);
	}
	...
	@Override
	public DossierProc2Agent deleteDossierProc2Agent(long id)
		throws PortalException, SystemException {
		return dossierProc2AgentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DossierProc2Agent deleteDossierProc2Agent(
		DossierProc2Agent dossierProc2Agent) throws SystemException {
		return dossierProc2AgentPersistence.remove(dossierProc2Agent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierProc2Agent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dossierProc2AgentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dossierProc2AgentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DossierProc2Agent fetchDossierProc2Agent(long id)
		throws SystemException {
		return dossierProc2AgentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DossierProc2Agent getDossierProc2Agent(long id)
		throws PortalException, SystemException {
		return dossierProc2AgentPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dossierProc2AgentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierProc2Agent> getDossierProc2Agents(int start, int end)
		throws SystemException {
		return dossierProc2AgentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDossierProc2AgentsCount() throws SystemException {
		return dossierProc2AgentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DossierProc2Agent updateDossierProc2Agent(
		DossierProc2Agent dossierProc2Agent) throws SystemException {
		return dossierProc2AgentPersistence.update(dossierProc2Agent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.dossiermgt.model.DossierProc2Agent",
			dossierProc2AgentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dossierProc2AgentPersistence.getDataSource();
	...
	private DossierProc2AgentLocalServiceClpInvoker _clpInvoker = new DossierProc2AgentLocalServiceClpInvoker();
}