...
import org.oep.core.dossiermgt.service.DossierProc2AgentService;
...
/**
 * Provides the base implementation for the dossier proc2 agent remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.dossiermgt.service.impl.DossierProc2AgentServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class DossierProc2AgentServiceBaseImpl extends BaseServiceImpl
	implements DossierProc2AgentService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.dossiermgt.service.DossierProc2AgentServiceUtil} to access the dossier proc2 agent remote service.
	 */
	...
	private DossierProc2AgentServiceClpInvoker _clpInvoker = new DossierProc2AgentServiceClpInvoker();
}