...
import org.oep.core.logging.model.NewUserLogClp;
import org.oep.core.logging.model.UserActivityClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"oep-core-logging-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "oep-core-logging-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(NewUserLogClp.class.getName())) {
			return translateInputNewUserLog(oldModel);
		}
	...
	public static Object translateInputNewUserLog(BaseModel<?> oldModel) {
		NewUserLogClp oldClpModel = (NewUserLogClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getNewUserLogRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.oep.core.logging.model.impl.NewUserLogImpl")) {
			return translateOutputNewUserLog(oldModel);
		}
		...
		if (oldModelClassName.equals(
					"org.oep.core.logging.model.impl.UserActivityImpl")) {
	...
	public static Object translateOutputNewUserLog(BaseModel<?> oldModel) {
		NewUserLogClp newModel = new NewUserLogClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setNewUserLogRemoteModel(oldModel);
