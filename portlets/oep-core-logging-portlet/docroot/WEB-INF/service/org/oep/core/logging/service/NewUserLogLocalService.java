...
/**
 * Provides the local service interface for NewUserLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NewUserLogLocalServiceUtil
...
public interface NewUserLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NewUserLogLocalServiceUtil} to access the new user log local service. Add custom service methods to {@link org.oep.core.logging.service.impl.NewUserLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
