...
/**
 * Provides the local service utility for NewUserLog. This utility wraps
 * {@link org.oep.core.logging.service.impl.NewUserLogLocalServiceImpl} and is the
 ...
 * @generated
 */
public class NewUserLogLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.oep.core.logging.service.impl.NewUserLogLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.oep.core.logging.model.NewUserLog addNewUserLog(
		org.oep.core.logging.model.NewUserLog newUserLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addNewUserLog(newUserLog);
	}
	...
	*/
	public static org.oep.core.logging.model.NewUserLog createNewUserLog(
		long id) {
		return getService().createNewUserLog(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.logging.model.NewUserLog deleteNewUserLog(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteNewUserLog(id);
	}
	...
	*/
	public static org.oep.core.logging.model.NewUserLog deleteNewUserLog(
		org.oep.core.logging.model.NewUserLog newUserLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteNewUserLog(newUserLog);
	}
	...
	*/
	...
	public static org.oep.core.logging.model.NewUserLog fetchNewUserLog(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchNewUserLog(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.logging.model.NewUserLog getNewUserLog(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getNewUserLog(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.oep.core.logging.model.NewUserLog> getNewUserLogs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getNewUserLogs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getNewUserLogsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getNewUserLogsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.oep.core.logging.model.NewUserLog updateNewUserLog(
		org.oep.core.logging.model.NewUserLog newUserLog)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateNewUserLog(newUserLog);
	}
	...
	*/
	public static org.oep.core.logging.model.NewUserLog addNewUserLog(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addNewUserLog(userId, groupId, companyId, createDate,
			userName, email, site, page, action, description, userActivityId);
	}
	...
	*/
	public static org.oep.core.logging.model.NewUserLog updateNewUserLog(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateNewUserLog(userId, groupId, companyId, createDate,
			userName, email, site, page, action, description, userActivityId);
	}
	...
	* @return Integer
	*/
	public static int countByParam(java.lang.String keyWord,
		boolean isUserName, boolean isEmail, java.util.Date fromDate,
		java.util.Date toDate,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .countByParam(keyWord, isUserName, isEmail, fromDate,
			toDate, serviceContext);
	}
	...
	*/
	public static java.util.List<org.oep.core.logging.model.NewUserLog> getByParam(
		...
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getByParam(keyWord, isUserName, isEmail, fromDate, toDate,
	...
	* @return: NewUserLog
	*/
	public static org.oep.core.logging.model.NewUserLog getByUserId(long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static NewUserLogLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					NewUserLogLocalService.class.getName());

			if (invokableLocalService instanceof NewUserLogLocalService) {
				_service = (NewUserLogLocalService)invokableLocalService;
			}
			else {
				_service = new NewUserLogLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(NewUserLogLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(NewUserLogLocalService service) {
	}

	private static NewUserLogLocalService _service;
}