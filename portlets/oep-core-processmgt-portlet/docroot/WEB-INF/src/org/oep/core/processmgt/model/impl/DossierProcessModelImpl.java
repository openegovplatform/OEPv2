...
public class DossierProcessModelImpl extends BaseModelImpl<DossierProcess>
	...
	public static final String TABLE_SQL_CREATE = "create table oep_processmgt_DossierProcess (dossierProcessId LONG not null primary key,userId LONG,groupId LONG,companyId LONG,createDate DATE null,modifiedDate DATE null,dossierProcId LONG,govAgentNo VARCHAR(75) null,govAgentName VARCHAR(75) null,startDossierStepId LONG,daysDuration INTEGER)";
	...
	public Object clone() {
		...
		dossierProcessImpl.setGovAgentNo(getGovAgentNo());
	...
	public CacheModel<DossierProcess> toCacheModel() {
		...
		dossierProcessCacheModel.govAgentNo = getGovAgentNo();

		String govAgentNo = dossierProcessCacheModel.govAgentNo;

		if ((govAgentNo != null) && (govAgentNo.length() == 0)) {
			dossierProcessCacheModel.govAgentNo = null;
		}
