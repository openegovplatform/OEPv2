...
public class StepTransitionModelImpl extends BaseModelImpl<StepTransition>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "newOrder", Types.INTEGER },
			{ "errorMessage", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table oep_processmgt_StepTransition (stepTransionId LONG not null primary key,userId LONG,groupId LONG,companyId LONG,createDate DATE null,modifiedDate DATE null,dossierProcessId LONG,preDossierStepId LONG,postDossierStepId LONG,precondition VARCHAR(75) null,transitionName VARCHAR(75) null,daysDuration INTEGER,dossierStatus VARCHAR(75) null,userAssignment INTEGER,newOrder INTEGER,errorMessage VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table oep_processmgt_StepTransition";
	public static final String ORDER_BY_JPQL = " ORDER BY stepTransition.stepTransionId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY oep_processmgt_StepTransition.stepTransionId ASC";
	...
	public static StepTransition toModel(StepTransitionSoap soapModel) {
		...
		model.setStepTransionId(soapModel.getStepTransionId());
		...
		model.setNewOrder(soapModel.getNewOrder());
	...
	public Object clone() {
		...
		stepTransitionImpl.setStepTransionId(getStepTransionId());
	...
	public CacheModel<StepTransition> toCacheModel() {
		...
		stepTransitionCacheModel.stepTransionId = getStepTransionId();
		...
		stepTransitionCacheModel.daysDuration = getDaysDuration();
		...
		stepTransitionCacheModel.newOrder = getNewOrder();
