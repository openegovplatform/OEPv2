...
import org.oep.core.processmgt.service.ProcessOrder2UserLocalService;
...
/**
 * Provides the base implementation for the process order2 user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.oep.core.processmgt.service.impl.ProcessOrder2UserLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 * @generated
 */
public abstract class ProcessOrder2UserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessOrder2UserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.oep.core.processmgt.service.ProcessOrder2UserLocalServiceUtil} to access the process order2 user local service.
	 */
	...
	public ProcessOrder2User addProcessOrder2User(
		ProcessOrder2User processOrder2User) throws SystemException {
		processOrder2User.setNew(true);

		return processOrder2UserPersistence.update(processOrder2User);
	}
	 ...
	 */
	@Override
	public ProcessOrder2User createProcessOrder2User(long id) {
		return processOrder2UserPersistence.create(id);
	}
	...
	@Override
	public ProcessOrder2User deleteProcessOrder2User(long id)
		throws PortalException, SystemException {
		return processOrder2UserPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProcessOrder2User deleteProcessOrder2User(
		ProcessOrder2User processOrder2User) throws SystemException {
		return processOrder2UserPersistence.remove(processOrder2User);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessOrder2User.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return processOrder2UserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return processOrder2UserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProcessOrder2User fetchProcessOrder2User(long id)
		throws SystemException {
		return processOrder2UserPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ProcessOrder2User getProcessOrder2User(long id)
		throws PortalException, SystemException {
		return processOrder2UserPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return processOrder2UserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProcessOrder2User> getProcessOrder2Users(int start, int end)
		throws SystemException {
		return processOrder2UserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProcessOrder2UsersCount() throws SystemException {
		return processOrder2UserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProcessOrder2User updateProcessOrder2User(
		ProcessOrder2User processOrder2User) throws SystemException {
		return processOrder2UserPersistence.update(processOrder2User);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.oep.core.processmgt.model.ProcessOrder2User",
			processOrder2UserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = processOrder2UserPersistence.getDataSource();
	...
	private ProcessOrder2UserLocalServiceClpInvoker _clpInvoker = new ProcessOrder2UserLocalServiceClpInvoker();
}